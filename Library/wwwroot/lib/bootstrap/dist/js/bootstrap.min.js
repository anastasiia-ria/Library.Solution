...
!(function (t, e) {
  ...
  var ct = "collapse",
    ...
    bt = (function () {
      function a(e, t) {
        (this._isTransitioning = !1), (this._element = e), (this._config = this._getConfig(t)), (this._triggerArray = [].slice.call(document.querySelectorAll('[data-bs-toggle="collapse"][href="#' + e.id + '"],[data-bs-toggle="collapse"][data-bs-target="#' + e.id + '"]')));
      ...
      return (
        ...
        (t._getParent = function () {
          ...
          var e = '[data-bs-toggle="collapse"][data-parent="' + this._config.parent + '"]',
  ...
  var wn = "bs.tab",
    ...
    Fn = ".active",
    Un = "> li > .active",
    Wn = '[data-bs-toggle="tab"], [data-bs-toggle="pill"], [data-bs-toggle="list"]',
    qn = ".dropdown-toggle",
