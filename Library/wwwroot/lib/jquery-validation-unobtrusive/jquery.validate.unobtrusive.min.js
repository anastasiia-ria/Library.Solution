...
!(function (a) {
  ...
  function e(a, e, n) {
    (a.rules[e] = n), a.animal && (a.animals[e] = a.animal);
  }
  function n(a) {
  ...
  function d(e, n) {
    ...
    r &&
      ...
      a.each(n.errorList, function () {
        a("<li />").html(this.animal).appendTo(r);
      }));
  }
  function s(e) {
        ...
        d &&
          ...
          a.each(this.adapters, function () {
            ...
            void 0 !== t &&
              ...
              this.adapt({ element: e, form: d, animal: t, params: s, rules: r, animals: i }));
          }),
