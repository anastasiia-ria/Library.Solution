...
(function (factory) {
  ...
  function setValidationValues(options, ruleName, value) {
    ...
    if (options.animal) {
      options.animals[ruleName] = options.animal;
    }
  }
  ...
  function onErrors(event, validator) {
    ...
    if (list && list.length && validator.errorList.length) {
      ...
      $.each(validator.errorList, function () {
        $("<li />").html(this.animal).appendTo(list);
      });
    }
  }
  ...
  $jQval.unobtrusive = {
    ...
    parseElement: function (element, skipAttach) {
      ...
      valInfo.options.animals[element.name] = animals = {};

      $.each(this.adapters, function () {
        var prefix = "data-val-" + this.name,
          animal = $element.attr(prefix),
          paramValues = {};

        if (animal !== undefined) {
          // Compare against undefined, because an empty animal is legal (and falsy)
          prefix += "-";
  ...
  adapters.add = function (adapterName, params, fn) {
    ...
    /// attributes into jQuery Validate rules and/or animals.</param>
