...
!(function () {
  ...
  const Mt = (e) => e.dom.nodeName.toLowerCase(),
    ...
    Gn = (e, t) => {
      ((e, t) => {
        ...
        Dt(Kt(e, "style").map(He), "") && Yt(e, "style");
    },
    Yn = (e, t) => {
      wn(e).each((n) => {
  ...
  const qr = (e, t = !0) =>
    ...
    vs = (e) => {
        ...
        d = ((e) => {
          ...
          return ds[e]
            ...
            : ((n = "id accesskey class dir lang style tabindex title role"),
              ...
              "html4" !== e && ((n += " contenteditable contextmenu draggable dropzone hidden spellcheck translate"), (o += " article aside details dialog figure main header footer hgroup section nav"), (r += " audio canvas command datalist mark meter output picture progress time wbr video ruby bdi keygen")),
              "html5-strict" !== e &&
                ((n += " xml:lang"),
              ...
              l("noscript", "", s),
              "html4" !== e && (l("wbr"), l("ruby", "", [r, "rt rp"].join(" ")), l("figcaption", "", s), l("mark rt rp summary bdi", "", r), l("canvas", "width height", s), l("video", "src crossorigin poster preload autoplay mediagroup loop muted controls width height buffered", [s, "track source"].join(" ")), l("audio", "src crossorigin preload autoplay mediagroup loop muted controls buffered volume", [s, "track source"].join(" ")), l("picture", "", "img source"), l("source", "src srcset type media sizes"), l("track", "kind src srclang label default"), l("datalist", "", [r, "option"].join(" ")), l("article section nav aside main header footer", "", s), l("hgroup", "", "h1 h2 h3 h4 h5 h6"), l("figure", "", [s, "figcaption"].join(" ")), l("time", "datetime", r), l("dialog", "open", s), l("command", "type label icon disabled checked radiogroup command"), l("output", "for form name", r), l("progress", "value max", r), l("meter", "value min max low high optimum", r), l("details", "open", [s, "summary"].join(" ")), l("keygen", "autofocus challenge disabled form keytype name")),
              "html5-strict" !== e && (d("script", "language xml:space"), d("style", "xml:space"), d("object", "declare classid code codebase codetype archive standby align border hspace vspace"), d("embed", "align name hspace vspace"), d("param", "valuetype type"), d("a", "charset name rev shape coords"), d("br", "clear"), d("applet", "codebase archive code object alt name width height align hspace vspace"), d("img", "name longdesc align border hspace vspace"), d("iframe", "longdesc frameborder marginwidth marginheight scrolling align"), d("font basefont", "size color face"), d("input", "usemap align"), d("select"), d("textarea"), d("h1 h2 h3 h4 h5 h6 div p legend caption", "align"), d("ul", "type compact"), d("li", "type"), d("ol dl menu dir", "compact"), d("pre", "width xml:space"), d("hr", "align noshade size width"), d("isindex", "prompt"), d("table", "summary width frame rules cellspacing cellpadding align bgcolor"), d("col", "width align char charoff valign"), d("colgroup", "width align char charoff valign"), d("thead", "align char charoff valign"), d("tr", "align char charoff valign bgcolor"), d("th", "axis align char charoff valign nowrap bgcolor width height"), d("form", "accept"), d("td", "abbr axis scope align char charoff valign nowrap bgcolor width height"), d("tfoot", "align char charoff valign"), d("tbody", "align char charoff valign"), d("area", "nohref"), d("body", "background bgcolor text link vlink alink")),
              "html4" !== e && (d("input button select textarea", "autofocus"), d("input textarea", "placeholder"), d("a", "download"), d("link script img", "crossorigin"), d("img", "loading"), d("iframe", "sandbox seamless allowfullscreen loading")),
              "html4" !== e &&
                $([t.video, t.audio], (e) => {
      ...
      const k = (e) => new RegExp("^" + e.replace(/([?+*])/g, ".$1") + "$"),
        ...
        E = (e) => {
          const t = /^(~)?(.+)$/;
          e &&
            ((ds.text_block_elements = ds.block_elements = null),
            ms(hs(e, ","), (e) => {
              const r = t.exec(e),
                a = "~" === r[1],
                i = a ? "span" : "div",
      ...
      e.valid_elements
        ...
        R("+ol[ul|ol],+ul[ul|ol]"),
        ms({ dd: "dl", dt: "dl", li: "ul ol", td: "tr", th: "tr", tr: "tbody thead tfoot", tbody: "table", thead: "table", tfoot: "table", legend: "fieldset", area: "map", param: "video audio object" }, (e, t) => {
          n[t] && (n[t].parentsRequired = hs(e));
        }),
        e.invalid_elements &&
          ms(gs(e.invalid_elements), (e) => {
            n[e] && delete n[e];
          }),
    ...
    xs = (e, t) => {
      const n = null != t ? t : {};
      for (const t in e) we(Cs, t) || (n[t] = e[t]);
    ...
    ws = (e, t, n, o) => {
      ...
      return (
        ...
        ((e) => y(e.preventDefault) || ((e) => e instanceof Event || x(e.initEvent))(e))(t) &&
          ((s.preventDefault = () => {
          ...
          ((e) => e.isDefaultPrevented === P || e.isDefaultPrevented === L)(s) || ((s.isDefaultPrevented = !0 === s.defaultPrevented ? P : L), (s.isPropagationStopped = !0 === s.cancelBubble ? P : L), (s.isImmediatePropagationStopped = L))),
        s
      );
    },
        ...
        (l = g[i]),
          ...
          r.domLoaded && "ready" === l && "complete" === e.readyState
            ...
            : (r.hasMouseEnterLeave ||
              ...
              (a = r.events[s][l]),
              a ? ("ready" === l && r.domLoaded ? n(Es({ type: l })) : a.push({ func: n, scope: o })) : ((r.events[s][l] = a = [{ func: n, scope: o }]), (a.fakeName = d), (a.capture = u), (a.nativeHandler = c), "ready" === l ? Ns(e, c, r) : Ss(e, d || l, c, u)));
      return (e = a = null), n;
    }
    unbind(e, t, n) {
      let o, r, s, a, i;
        ...
        R = (e, n, o) => {
          ...
          L(e, (e) => {
            ...
            m(n)
              ...
              t.update_styles && Ds(d, r);
          });
        },
        A = (e, t, n) => {
          const o = g(e);
          if (!y(o) && yo(o)) return n ? $n(mn(o), Ms(t)) : ("float" === (t = t.replace(/-(\D)/g, (e, t) => t.toUpperCase())) && (t = "cssFloat"), o.style ? o.style[t] : void 0);
        },
        O = (e) => {
          let t, n;
          const o = g(e);
          return (t = A(o, "width")), (n = A(o, "height")), -1 === t.indexOf("px") && (t = 0), -1 === n.indexOf("px") && (n = 0), { w: parseInt(t, 10) || o.offsetWidth || o.clientWidth, h: parseInt(n, 10) || o.offsetHeight || o.clientHeight };
        },
        T = (e, t) => {
          if (!e) return !1;
          const n = p(e) ? e : [e];
  ...
  const zs = (e) => {
    ...
    qs = () => {
      const e = [],
        ...
        a = (e, n) => {
          const o = $s.getCode();
          !o || (n && -1 === ("," + (n || "") + ",").indexOf("," + o + ",")) || Us.ScriptLoader.add(t[e] + "/langs/" + o + ".js");
        },
        i = (e, t = "added") =>
          ("added" === t && ((e) => we(n, e))(e)) || ("loaded" === t && s(e))
            ? Promise.resolve()
            : new Promise((n) => {
  ...
  const Ws = () => {
    ...
    Ys = (e, t) => {
      ...
      return (
        $(Nn(e), (e) => {
          t(e) && (n = n.concat([e])), (n = n.concat(Ys(e, t)));
        }),
        n
      );
    },
  ...
  const sa = (e) => {
    ...
    Ia = (e) => {
      ...
      return (
        (t = n.length > 0 ? ma(n[0]) : ma(e.getBoundingClientRect())),
        !La(e) && Aa(e) && Ma(t)
          ? ((e) => {
    ...
    Ua = (e, t, n) => {
            ...
            const t = [],
              ...
              o = (e, o) => {
                ...
                if (o < e.data.length) {
                  ...
                  if (xa(e.data[o - 1]) && (r.setStart(e, o), r.setEnd(e, o + 1), !Pa(r))) return n(Fa(Ia(r), !1)), t;
                }
      ...
      return {
        ...
        offset: N(t),
        toRange: () => {
          const n = Ba(e.ownerDocument);
          return n.setStart(e, t), n.setEnd(e, t), n;
        },
        getClientRects: o,
        isVisible: () => o().length > 0,
        isAtStart: () => (Ra(e), 0 === t),
        isAtEnd: () => (Ra(e) ? t >= e.data.length : t >= e.childNodes.length),
        isEqual: (n) => n && e === n.container() && t === n.offset(),
        getNode: (n) => Ta(e, n ? t - 1 : t),
      };
    };
  ...
  const za = (e, t) => {
    ...
    Ga = (e) => {
      let t;
      return (
        (t = Va(e) ? "text()" : e.nodeName.toLowerCase()),
        t +
          "[" +
          ((e) => {
            let t, n;
    ...
    Xa = (e, t) => {
        ...
        (e, t) => {
          ...
          return n
            ? ("text()" === n[1] && (n[1] = "#text"),
              ((e, t, n) => {
                let o = Wa(e);
                return (o = Re(o, (e, t) => !Va(e) || !Va(o[t - 1]))), (o = Re(o, Co([t]))), o[n];
      ...
      return s
        ? Va(s)
          ...
          : ((n = "after" === n ? $a(s) + 1 : $a(s)), Ua(s.parentNode, n))
        : null;
    },
    Qa = Mo,
    Ja = (e, t, n, o, r) => {
    ...
    oi = (e, t, n) => {
      ...
      return a
        ? ((r = a.tagName), { name: r, index: Za(n.dom, r, a) })
        : ((e, t, n, o) => {
            const r = t.dom,
              s = {};
      ...
      return void 0 !== e.replacement
        ? m(e.replacement)
          ? 0 === e.start.length
            ...
            : di.value({ type: "inline-command", start: "", end: e.start, cmd: "mceInsertContent", value: e.replacement })
              ...
              ? ((e, t) => {
                  const n = t.container(),
                    o = ((e, t) => {
                      ...
                      .map((e) => (e < t.offset() ? Ua(n, t.offset() - 1) : t))
                      .getOr(t);
                  return dd(e), o;
                })(e, t)
              : id(e, t))(e, t),
        ...
        show: (e, c) => {
          ...
          if (!n(c))
            return (
              ...
              hd(a.nextSibling) ? (u.setStart(a, 0), u.setEnd(a, 0)) : (u.setStart(a, 1), u.setEnd(a, 1)),
              u
            );
          {
            a = ((e, t, n) => {
  ...
  const qd = Mo,
    ...
    ec = (e, t, n) => {
      ...
      if (t.isEqual(Ua.after(n)) && n.lastChild) {
        if (((a = Ua.after(n.lastChild)), Nd(e) && Yd(n.lastChild) && Kd(n.lastChild))) return Gd(n.lastChild) ? Ua.before(n.lastChild) : a;
      } else a = t;
      const i = a.container();
      let l = a.offset();
      if (Wd(i)) {
    ...
    lc = (e, t) => {
      ...
      return No(n)
        ? M.some(Ua(n, e ? 0 : n.data.length))
        : n
        ? Lr(n)
          ? M.some(e ? Ua.before(n) : Do((o = n)) ? Ua.before(o) : Ua.after(o))
          : ((e, t, n) => {
    ...
    kc = (e, t, n) =>
      ((e, t, n) =>
        2 === t
          ...
          ? ((e) => {
              const t = e.getRng();
              return { start: Ya(e.dom.getRoot(), Ua.fromRangeStart(t)), end: Ya(e.dom.getRoot(), Ua.fromRangeEnd(t)) };
            })(e)
          : t
          ? ((e) => ({ rng: e.getRng() }))(e)
          : si(e, !1))(e, t, n),
      ...
      ((e, t) => {
        ...
        if (t) {
          if (hc(t))
            return ((e, t) => {
              const n = e.createRng();
              return Cc(e, !0, t, n) && Cc(e, !1, t, n) ? M.some(n) : M.none();
            })(n, t);
          if (((e) => m(e.start))(t))
            return M.some(
              ((e, t) => {
  ...
  const Nc = (e) => "" !== e && -1 !== " \f\n\r\t\v".indexOf(e),
    ...
    Pc = (e) =>
      ((e) => {
        if ("transparent" === e) return M.some(Dc(0, 0, 0, 0));
        const t = Tc.exec(e);
        if (null !== t) return M.some(Lc(t[1], t[2], t[3], "1"));
        const n = Bc.exec(e);
        return null !== n ? M.some(Lc(n[1], n[2], n[3], n[4])) : M.none();
      })(e)
        .map(Oc)
        .map((e) => "#" + e.value)
        .getOr(e),
    ...
    Ic = (e, t, n) => {
      ...
      if ((r !== n.endContainer || !(s = r.childNodes[o]) || !/^(IMG)$/.test(s.nodeName)) && yo(r)) {
        ...
        for (let e = a.current(); e; e = a.next()) if (No(e) && !jc(e)) return n.setStart(e, 0), void t.setRng(n);
      }
    },
    Fc = (e, t, n) => {
      if (e) {
    ...
    iu = (e, t, n, o, r) => {
      ...
      for (let o = 0; o < s.length; o++)
        for (let r = 0; r < t.length; r++) {
          const a = t[r];
          if ((!C(a.collapsed) || a.collapsed === n.collapsed) && Yc(a) && e.is(s[o], a.selector)) return s[o];
        }
      return o;
    },
    lu = (e, t, n, o) => {
    ...
    du = (e, t, n, o) => {
      ...
      return !C(n[o]) && (!(r !== t && !y(r) && !e.isBlock(r)) || du(e, t, r, o));
    },
    cu = (e, t, n, o, r) => {
      let s = n;
      ...
      for (;;) {
        ...
        for (let t = s[a]; t; t = t[a]) {
          const n = No(t) && !du(e, i, t, a);
          if (!Jc(t) && (!Do((l = t)) || !l.getAttribute("data-mce-bogus") || l.nextSibling) && !eu(t, n)) return s;
        }
    ...
    mu = (e, t, n, o = !1) => {
      ...
      const l = e.dom,
        d = n[0];
      return (
        yo(r) && r.hasChildNodes() && ((r = ya(r, s)), No(r) && (s = 0)),
        yo(a) && a.hasChildNodes() && ((a = ya(a, t.collapsed ? i : i - 1)), No(a) && (i = a.nodeValue.length)),
        (r = nu(l, r)),
        (a = nu(l, a)),
        uu(r) && ((r = Jc(r) ? r : r.parentNode), (r = t.collapsed ? r.previousSibling || r : r.nextSibling || r), No(r) && (s = t.collapsed ? r.length : 0)),
        uu(a) && ((a = Jc(a) ? a : a.parentNode), (a = t.collapsed ? a.nextSibling || a : a.previousSibling || a), No(a) && (i = t.collapsed ? 0 : a.length)),
        t.collapsed &&
          (au(l, e.getBody(), r, s, !0, o).each(({ container: e, offset: t }) => {
            (r = e), (s = t);
          }),
          au(l, e.getBody(), a, i, !1, o).each(({ container: e, offset: t }) => {
            (a = e), (i = t);
          })),
        (Xc(d) || d.block_expand) && ((Xc(d) && No(r) && 0 !== s) || (r = cu(l, n, r, s, !0)), (Xc(d) && No(a) && i !== a.nodeValue.length) || (a = cu(l, n, a, i, !1))),
        Qc(d) && ((r = iu(l, n, t, r, "previousSibling")), (a = iu(l, n, t, a, "nextSibling"))),
        (Gc(d) || Yc(d)) && ((r = lu(e, n, r, "previousSibling")), (a = lu(e, n, a, "nextSibling")), Gc(d) && (l.isBlock(r) || (r = cu(l, n, r, s, !0)), l.isBlock(a) || (a = cu(l, n, a, i, !1)))),
        yo(r) && ((s = l.nodeIndex(r)), (r = r.parentNode)),
        yo(a) && ((i = l.nodeIndex(a) + 1), (a = a.parentNode)),
    ...
    pu = (e, t) => {
      const n = Xs(t, "td[data-mce-selected],th[data-mce-selected]");
      return n.length > 0
        ? n
        : ((e) =>
            K(
        ...
        c = (t) => {
          switch (
            ((e, t, n, o) =>
              wn(t).fold(
                () => "skipping",
                (r) => ("br" === o || ((e) => zt(e) && Eu(e) === ur)(t) ? "valid" : ((e) => Ut(e) && sn(e, Qs()))(t) ? "existing" : gc(t.dom) ? "caret" : zc(e, n, o) && zc(e, Mt(r), n) ? "valid" : "invalid-child")
              ))(e, t, "span", Mt(t))
          ) {
            case "invalid-child": {
              l();
    ...
    Ou = (e) => {
      ...
      ((e, t) => {
        e.serializer.addTempAttr(ea()),
          e.serializer.addNodeFilter("span", (e) => {
            $(e, (e) => {
              ((e) => M.from(e.attr(Js())).bind(t.lookup))(e).each((t) => {
    ...
    zu = (e, t) => {
      ...
      const E = { nw: [0, 0, -1, -1], ne: [1, 0, 1, -1], se: [1, 1, 1, 1], sw: [0, 1, -1, 1] },
        ...
        A = (e) => {
          ...
          ((e, t) => {
            if ("longpress" === e.type || 0 === e.type.indexOf("touch")) {
              const n = e.touches[0];
              return N(e.target) && !Bu(n.clientX, n.clientY, t);
            }
            return N(e.target) && !Bu(e.clientX, e.clientY, t);
        ...
        L = (e) => {
          ...
          (n = e.screenX - c),
            ...
            (h = h < 5 ? 5 : h),
            (b = b < 5 ? 5 : b),
            (d = (N(s) || R(s)) && !1 !== rl(t) ? !Uu.modifierPressed(e) : Uu.modifierPressed(e)),
            d && (x(n) > x(r) ? ((b = w(h * g)), (h = w(b / g))) : ((h = w(b / g)), (b = w(h * g)))),
            D(a, h, b),
            (v = l.startPos.x + n),
            (y = l.startPos.y + r),
            (v = v > 0 ? v : 0),
            (y = y > 0 ? y : 0),
            o.setStyles(i, { left: v, top: y, display: "block" }),
            (i.innerHTML = h + " &times; " + b),
            l[2] < 0 && a.clientWidth <= h && o.setStyle(a, "left", void 0 + (m - h)),
            l[3] < 0 && a.clientHeight <= b && o.setStyle(a, "top", void 0 + (f - b)),
            (n = k.scrollWidth - S),
            (r = k.scrollHeight - _),
            n + r !== 0 && o.setStyles(i, { left: v - n, top: y - r }),
            p ||
              (((e, t, n, o, r) => {
                e.dispatch("ObjectResizeStart", { target: t, width: n, height: o, origin: r });
              })(t, s, m, f, "corner-" + l.name),
              (p = !0));
        },
        P = () => {
          const e = p;
          (p = !1),
            e && (B(s, "width", h), B(s, "height", b)),
            o.unbind(v, "mousemove", L),
            o.unbind(v, "mouseup", P),
            y !== v && (o.unbind(y, "mousemove", L), o.unbind(y, "mouseup", P)),
            o.remove(a),
            o.remove(i),
            o.remove(d),
            M(s),
            e &&
              ...
              })(t, s, h, b, "corner-" + l.name),
              o.setAttrib(s, "style", o.getAttrib(s, "style"))),
            t.nodeChanged();
        },
        M = (e) => {
          U();
          ...
          const B = t.dispatch("ObjectSelected", { target: e }),
            M = o.getAttrib(s, n, "1");
          T(e) && !B.isDefaultPrevented()
            ? r(E, (e, t) => {
                let r;
                (r = o.get("mceResizeHandle" + t)),
                  r && o.remove(r),
                  (r = o.add(k, "div", { id: "mceResizeHandle" + t, "data-mce-bogus": "all", class: "mce-resizehandle", unselectable: !0, style: "cursor:" + t + "-resize; margin:0; padding:0" })),
                  ...
                  (e.elm = r),
                  o.setStyles(r, { left: N * e[0] + C - r.offsetWidth / 2, top: A * e[1] + x - r.offsetHeight / 2 });
              })
            : I(),
            o.getAttrib(s, n) || s.setAttribute(n, M);
        },
        I = () => {
          U(),
        ...
        F = (s) => {
          ...
          p ||
            t.removed ||
            (r(o.select("img[data-mce-selected],hr[data-mce-selected]"), (e) => {
              e.removeAttribute(n);
            }),
            (l = "mousedown" === s.type ? s.target : e.getNode()),
            (l = null === (a = Ko(mn(l), "table,img,figure.image,hr,video,span.mce-preview-object").getOrUndefined()) || void 0 === a ? void 0 : a.dom),
            d(l, k) && (z(), (i = e.getStart(!0)), d(i, l) && d(e.getEnd(!0), l)) ? M(l) : I());
        },
        U = () => {
          fe(E, (e) => {
      ...
      return (
        t.on("init", () => {
          ...
          t.on("nodechange ResizeEditor ResizeWindow ResizeContent drop FullscreenStateChanged", e.throttle),
            t.on("keyup compositionend", (t) => {
              s && "TABLE" === s.nodeName && e.throttle(t);
            }),
            t.on("hide blur", I),
            t.on("contextmenu longpress", A, !0);
        }),
        t.on("remove", U),
        {
          isResizable: T,
  ...
  const qu = (e, t, n, o) => ({ start: e, soffset: t, finish: n, foffset: o }),
    Wu = document.caretPositionFromPoint
      ? (e, t, n) => {
          var o, r;
    ...
    Xu = {
      ...
      getWin: (e) => {
        const t = ((e) => e.match({ domRange: (e) => mn(e.startContainer), relative: (e, t) => Gu.getStart(e), exact: (e, t, n, o) => e }))(e);
        return xn(t);
      },
      range: qu,
    },
    Qu = (e, t) => {
      const n = Mt(e);
      return "input" === n ? Gu.after(e) : j(["br", "img"], n) ? (0 === t ? Gu.before(e) : Gu.after(e)) : Gu.on(e, t);
    },
    Ju = (e, t) => {
    ...
    tm = (e) => {
      ...
      return ((e, t) => {
        const n = ((e, t) => t.match({ domRange: (e) => ({ ltr: N(e), rtl: M.none }), relative: (t, n) => ({ ltr: De(() => ju(e, t, n)), rtl: De(() => M.some(ju(e, n, t))) }), exact: (t, n, o, r) => ({ ltr: De(() => Vu(e, t, n, o, r)), rtl: De(() => M.some(Vu(e, o, r, t, n))) }) }))(e, t);
        return ((e, t) => {
          const n = t.ltr();
          return n.collapsed
            ? t
    ...
    um = (e, t, n, o) => {
      ...
      if ((yo(r) && s > r.childNodes.length - 1 && (l = !1), To(r) && ((r = a), (s = 0)), r === a)) {
        if (l && ((i = r.childNodes[s > 0 ? s - 1 : 0]), i)) {
          ...
          if (u[i.nodeName] || am(i)) return M.none();
        }
        if (r.hasChildNodes()) {
  ...
  const Cm = (e) => "textarea" === Mt(e),
    ...
    Sm = (e, t, n, o) => {
      ...
      const a = ((e, t) => {
        const n = ((e, t) => {
            const n = Nn(e);
            if (0 === n.length || Cm(e)) return { element: e, offset: t };
            if (t < n.length && !Cm(n[t])) return { element: n[t], offset: 0 };
            {
              const o = n[n.length - 1];
              return Cm(o) ? { element: e, offset: t } : "img" === Mt(o) ? { element: o, offset: 1 } : zt(o) ? { element: o, offset: Eu(o).length } : { element: o, offset: Nn(o).length };
            }
          })(e, t),
      ...
      const t = ((e) => e.inline)(e)
        ? ((n = mn(e.getBody())),
          ((e) => {
            ...
            return (t && 0 !== t.rangeCount ? M.from(t.getRangeAt(0)) : M.none()).map(Hm);
          })(xn(n).dom).filter(Vm(n)))
        : M.none();
      var n;
    ...
    Wm = (e) =>
      (e.bookmark ? e.bookmark : M.none())
        .bind((t) => {
          return (n = mn(e.getBody())), (o = t), M.from(o).filter(Vm(n)).map(zm);
          var n, o;
        })
        .bind($m),
    Km = {
  ...
  const Xm = Is.DOM,
      ...
      ((e) => {
        ...
        e.on("init", () => {
          e.inline &&
            ((e, t) => {
              ...
              Is.DOM.bind(document, "mouseup", n),
                e.on("remove", () => {
        ...
        Ym ||
          ((Ym = (t) => {
            ...
            n &&
              Fn(t).each((t) => {
                t.ownerDocument === document && (t === document.body || Qm(n, t) || e.focusedEditor !== n || (n.dispatch("blur", { focusedEditor: null }), (e.focusedEditor = null)));
              });
          }),
    ...
    ef = (e, t) => {
      ((e, t) => ((e) => (e.collapsed ? M.from(ya(e.startContainer, e.startOffset)).map(mn) : M.none()))(t).bind((t) => (sr(t) ? M.some(t) : !1 === vn(e, t) ? M.some(e) : M.none())))(mn(e.getBody()), t)
        .bind((e) => uc(e.dom))
        .fold(
          () => {
    ...
    nf = (e) =>
      e.inline
        ? ((e) => {
            const t = e.getBody();
            return t && ((n = mn(t)), Im(n) || ((o = n), Fm(Pn(o)).filter((e) => o.dom.contains(e.dom))).isSome());
            var n, o;
          })(e)
        : ((e) => e.iframeElement && Im(mn(e.iframeElement)))(e),
    ...
    rf = (e, t, n, o, r) => {
      ...
      return M.from(s)
        ...
        .bind((e) => (Ut(e) ? M.some(e) : wn(e).filter(Ut)))
        .map((e) => e.dom)
        .getOr(e);
    },
    ...
    uf = (e) => {
      const t = Nu(e)
        .filter((e) => 0 !== e.trim().length || e.indexOf(dr) > -1)
        .isSome();
      return t || j(cf, Mt(e));
    },
    ...
    xf = (e, t, n) => {
      ...
      for (; 0 !== a; )
        for (o.lastIndex = i; ; ) {
          ...
          if (null === e) return i;
          if ("!" === e[1]) {
            i = ze(e[2], "--") ? Cf(t, !1, e.index + "!--".length) : Cf(t, !0, e.index + 1);
            break;
          }
          {
  ...
  const Of = ["font", "text-decoration", "text-emphasis"],
    ...
    tg = (e, t, n) =>
      Zf(t, n).fold(
        () => Jf(e, t.dom, n).forall((e) => !1 === Td(e, n, t.dom)),
        (t) => Jf(e, t.dom, n).isNone()
      ),
    ng = O(tg, !1),
    og = O(tg, !0),
    rg = O(eg, !1),
    ...
    fg = (e, t) => {
      const n = K(Qf(mn(t.container()), e), Zo);
      return ie(n).getOr(e);
    },
    ...
    hg = (e) =>
      jd(e)
        .bind((e) => $o(e, Ut))
        .exists((e) => ((e) => j(["pre", "pre-wrap"], e))($n(e, "white-space"))),
            ...
            o =
              ...
              ((e) => {
                const t = e.data,
                  n = ((e) => {
                    const t = e.split("");
                    return H(t, (e, n) => (Ec(e) && n > 0 && n < t.length - 1 && Rc(t[n - 1]) && Rc(t[n + 1]) ? " " : e)).join("");
                  })(t);
    ...
    Ng = (e, t) =>
      ((e, t) => {
        ...
        ? Ua(t.container(), t.offset() - 1)
        : t,
    Rg = (e) => {
      return Lr(e.previousSibling) ? M.some(((t = e.previousSibling), No(t) ? Ua(t, t.data.length) : Ua.after(t))) : e.previousSibling ? mc(e.previousSibling) : M.none();
      var t;
    },
    Ag = (e) => {
      return Lr(e.nextSibling) ? M.some(((t = e.nextSibling), No(t) ? Ua(t, 0) : Ua.before(t))) : e.nextSibling ? uc(e.nextSibling) : M.none();
      var t;
    },
    Og = (e, t, n) =>
      ((e, t, n) =>
        e
          ? ((e, t) =>
              Ag(t)
                .orThunk(() => Rg(t))
                .orThunk(() => ((e, t) => dc(e, Ua.after(t)).fold(() => cc(e, Ua.before(t)), M.some))(e, t)))(t, n)
          : ((e, t) =>
              Rg(t)
                .orThunk(() => Ag(t))
                .orThunk(() =>
                  ((e, t) => {
                    ...
                    return cc(e, n).fold(() => dc(e, Ua.after(t)), M.some);
                  })(e, t)
                ))(t, n))(e, t, n).map(O(Ng, n)),
    Tg = (e, t, n) => {
      n.fold(
        () => {
          e.focus();
    ...
    Dg = (e) => {
      if (qr(e)) {
        ...
        return eo(e), Jn(e, t), M.some(Ua.before(t.dom));
      }
      return M.none();
    },
    Lg = (e, t, n, o = !0) => {
        ...
        const e = Fg(n.startContainer, o),
          ...
          r = e
            .bind(
              (
                (e) => (t) =>
                  bu(t, e).bind((e) => le(Pg(e)).map((e) => Mg(t, e)))
              )(o)
            )
            .bind(jg(o)),
          s = t
            .bind(
              (
                (e) => (t) =>
                  bu(t, e).bind((e) => ie(Pg(e)).map((e) => Mg(e, t)))
              )(o)
            )
            .bind(jg(o));
    ...
    Wg = (e, t) => {
      ...
      return ((e, t, n) =>
        ...
        ? o.map((e) => Ig.singleCellTable(t, e.start))
        : r.isMultiTable
        ? ((e, t, n, o) =>
            Vg(e, t, n, o).bind(({ start: e, end: o }) => {
              const r = e.bind($g).getOr([]),
                s = o.bind($g).getOr([]);
              if (r.length > 0 && s.length > 0) {
                const e = qg(n, t);
                return M.some(Ig.multiTable(r, s, e));
              }
              return M.none();
            }))(o, r, t, n)
        : ((e, t, n, o) =>
            Vg(e, t, n, o)
              ...
              .bind((e) => {
                const { isSameTable: o } = t,
                  r = $g(e).getOr([]);
                if (o && e.cells.length === r.length) return M.some(Ig.fullTable(e.table));
                if (r.length > 0) {
                  if (o) return M.some(Ig.partialTable(r, M.none()));
                  {
                    const e = qg(n, t);
                    return M.some(Ig.partialTable(r, M.some({ ...t, rng: e })));
                  }
                }
                return M.none();
              }))(o, r, t, n);
    ...
    Kg = (e) => {
      var t;
      return (8 === It((t = e)) || "#comment" === Mt(t) ? kn(e) : On(e)).bind(Kg).orThunk(() => M.some(e));
    },
    Gg = (e) =>
      $(e, (e) => {
    ...
    sp = (e, t, n) => {
      ...
      return np(o, n).fold(
        () =>
          ((e, t, n, o) => {
            const r = Ua.fromRangeStart(e.selection.getRng());
            return tp(n, o).bind((o) => (qr(o) ? op(e, o) : ((e, t, n, o, r) => ac(n, e.getBody(), r).bind((e) => tp(t, mn(e.getNode())).bind((e) => (bn(e, o) ? M.none() : M.some(S)))))(e, n, t, o, r)));
          })(e, t, o, n).orThunk(() =>
            Pt(
              ((e, t) => {
                const n = Ua.fromRangeStart(e.selection.getRng());
                return rp(t, n) || sc(t, e.getBody(), n).exists((e) => rp(t, e));
              })(e, t),
              S
            )
          ),
        (n) =>
          ((e, t, n, o) => {
            ...
            return qr(o)
              ? op(e, o)
              : ((e, t, n, o, r) =>
                  ac(n, e.getBody(), r).fold(
                    () => M.some(S),
                    (s) =>
                      ((e, t, n, o) =>
                        uc(e.dom)
                          .bind((r) => mc(e.dom).map((e) => (t ? n.isEqual(r) && o.isEqual(e) : n.isEqual(e) && o.isEqual(r))))
                          .getOr(!0))(o, n, r, s)
                        ? ((e, t) => op(e, t))(e, o)
                        : ((e, t, n) =>
                            np(e, mn(n.getNode())).fold(
                              () => M.some(S),
                              (e) => Pt(!bn(e, t), S)
                            ))(t, o, s)
                  ))(e, n, t, o, r);
      ...
      return e.selection.isCollapsed() && 0 === o.length
        ...
        : ((e, t, n) => {
            ...
            return 0 !== n.length
              ...
              : ((e, t, n, o) =>
                  np(t, o).fold(
                    () => ((e, t, n) => Wg(t, n).bind((t) => t.fold(O(Zg, e), O(ep, e), O(Qg, e), O(Jg, e))))(e, t, n),
                    (t) => ((e, t) => op(e, t))(e, t)
                  ))(e, o, r, t);
          })(e, n, o);
    },
    ...
    wp = (e, t, n, o) => {
      ...
      return d(1)
        ...
        : d(2)
        ? ((e, t, n, o) => (o.insertAfter(t.reverse(), e), xp(t[0], n)))(s, a, l, t)
        : ((e, t, n, o) => {
            const r = ((e, t) => {
    ...
    Sp = (e, t, n) => {
      ...
      const a = e.selection,
        ...
        u = '</span></span><span id="mce_marker" data-mce-type="bookmark">&#xFEFF;</span>';
      -1 === t.indexOf("{$caret}") && (t += "{$caret}"), (t = t.replace(/\{\$caret\}/, u)), (r = a.getRng());
      const m = r.startContainer || (r.parentElement ? r.parentElement() : null),
        f = e.getBody();
      m === f && a.isCollapsed() && i.isBlock(f.firstChild) && ((e, t) => t && !e.schema.getVoidElements()[t.nodeName])(e, f.firstChild) && i.isEmpty(f.firstChild) && ((r = i.createRng()), r.setStart(f.firstChild, 0), r.setEnd(f.firstChild, 0), a.setRng(r)),
        a.isCollapsed() ||
          ((e) => {
            const t = e.dom,
      ...
      return (
          ...
          o.remove(t),
            l &&
              ...
              !(n = ((t) => {
                ...
                if (((n = tc(e.getBody()).next(n)), n)) return n.toRange();
              })(a))
        ...
        ((e, t) => {
          M.from(e.getParent(t, "td,th")).map(mn).each(Yf);
        })(i, a.getStart()),
        t
      );
    },
    ...
    Bp = (e, t, n, o, r) => {
      ...
      return t !== s && ((t = e.dom.getParent(t, (t) => !!Tp(e, t, n) || t.parentNode === s || !!Pp(e, t, n, o, !0))), !!Pp(e, t, n, o, r));
    },
    ...
    Lp = (e, t, n, o, r, s) => {
      ...
      if (a)
        ...
        } else for (let n = 0; n < a.length; n++) if ("attributes" === o ? e.getAttrib(t, a[n]) : qc(e, t, a[n])) return !0;
      return !0;
    },
    Pp = (e, t, n, o, r) => {
      ...
      if (s && t)
        for (let n = 0; n < s.length; n++) {
          ...
          if (Dp(e.dom, t, i) && Lp(a, t, i, "attributes", r, o) && Lp(a, t, i, "styles", r, o)) {
            const n = i.classes;
            if (n) for (let r = 0; r < n.length; r++) if (!e.dom.hasClass(t, Vc(n[r], o))) return;
            return i;
          }
        }
    },
    ...
    jp = (e) => {
      const t = cn("span");
      return qt(t, { id: Fp, "data-mce-bogus": "1", "data-mce-type": "format-caret" }), e && Jn(t, un(Ip)), t;
    },
    Vp = (e, t, n = !0) => {
      const o = e.dom,
        r = e.selection;
    ...
    qp = (e, t) => {
      const n = G(e, (e, t) => $p(e, t.cloneNode(!1)), t);
    ...
    Kp = (e, t) => {
      const n = e.schema.getTextInlineElements();
      return we(n, Mt(t)) && !gc(t.dom) && !ko(t.dom);
    },
    Gp = {},
    Yp = Re,
    Xp = Ee;
  ...
  const Qp = Bt.each,
    ...
    gh = (e, t, n, o, r) => {
      ...
      const i = o;
      if (Xc(t) && "all" === t.remove && p(t.preserve_attributes)) {
        const e = K(a.getAttribs(i), (e) => j(t.preserve_attributes, e.name.toLowerCase()));
        if ((a.removeAllAttribs(i), $(e, (e) => a.setAttrib(i, e.name, e.value)), e.length > 0)) return sh.rename("span");
      }
      if ("all" !== t.remove) {
        ih(t.styles, (e, o) => {
          (e = $c(Vc(e, n), o + "")), w(o) && ((o = e), (r = null)), (t.remove_similar || !r || lh(qc(a, r, o), e)) && a.setStyle(i, o, ""), (s = !0);
        }),
          s && "" === a.getAttrib(i, "style") && (i.removeAttribute("style"), i.removeAttribute("data-mce-style")),
          ih(t.attributes, (e, o) => {
            let s;
            if (((e = Vc(e, n)), w(o) && ((o = e), (r = null)), t.remove_similar || !r || lh(a.getAttrib(r, o), e))) {
              if (
                "class" === o &&
                (e = a.getAttrib(i, o)) &&
                ((s = ""),
              ...
              if ((ah.test(o) && i.removeAttribute("data-mce-" + o), "style" === o && Co(["li"])(i) && "none" === a.getStyle(i, "list-style-type"))) return i.removeAttribute(o), void a.setStyle(i, "list-style-type", "none");
              "class" === o && i.removeAttribute("className"), i.removeAttribute(o);
            }
          }),
          ih(t.classes, (e) => {
            (e = Vc(e, n)), (r && !a.hasClass(r, e)) || a.removeClass(i, e);
          });
      ...
      return "none" !== t.remove
        ? (((e, t, n) => {
            ...
            Gc(n) &&
              o === s.getRoot() &&
              ((n.list_block && lh(t, n.list_block)) ||
                $(de(t.childNodes), (t) => {
                  zc(e, a, t.nodeName.toLowerCase()) ? (r ? r.appendChild(t) : ((r = mh(s, t, a)), s.setAttribs(r, Bi(e)))) : (r = null);
                })),
              (((e) => Yc(e) && Xc(e) && Dt(xe(e, "mixed"), !0))(n) && !lh(n.inline, t)) || s.remove(t, !0);
          })(e, i, t),
          sh.removed())
        : sh.keep();
    },
    ...
    bh = (e, t, n, o, r) => {
      ...
      const l = e.dom,
        ...
        c = (o) => {
          const i = ((e, t, n, o, r) => {
            let s;
            return (
              $(Kc(e.dom, t.parentNode).reverse(), (t) => {
        ...
        m = (t) => {
          ...
          $(["underline", "line-through", "overline"], (n) => {
            yo(t) && e.dom.getStyle(t, "text-decoration") === n && t.parentNode && Wc(l, t.parentNode) === n && ph(e, { deep: !1, exact: !0, inline: "span", styles: { textDecoration: n } }, null, t);
          });
        },
        f = (e) => {
          const t = l.get(e ? "_start" : "_end");
          let n = t[e ? "firstChild" : "lastChild"];
          return ((e) => _c(e) && yo(e) && ("_start" === e.id || "_end" === e.id))(n) && (n = n[e ? "firstChild" : "lastChild"]), No(n) && 0 === n.data.length && (n = e ? t.previousSibling || t.nextSibling : t.nextSibling || t.previousSibling), l.remove(t, !0), n;
        },
        g = (t) => {
          let n,
            o,
            r = mu(e, t, s, t.collapsed);
          if (a.split) {
            if (((r = gm(r)), (n = ch(e, r, !0)), (o = ch(e, r)), n !== o)) {
              if (((n = uh(n, !0)), (o = uh(o, !1)), dh(l, n, o))) {
                const e = M.from(n.firstChild).getOr(n);
                return c(fh(l, e, !0, "span", { id: "_start", "data-mce-type": "bookmark" })), void f(!0);
              }
              if (dh(l, o, n)) {
                const e = M.from(o.lastChild).getOr(o);
                return c(fh(l, e, !1, "span", { id: "_end", "data-mce-type": "bookmark" })), void f(!1);
              }
      ...
      if (o) {
        ...
        d.isCollapsed() && Xc(a) && !hu(e).length
          ? Wp(e, t, n, r)
          : (Su(d, !0, () => {
              ku(e, g);
            }),
            Xc(a) && Mp(e, t, n, d.getStart()) && Ic(l, d, d.getRng()),
            e.nodeChanged()),
          Pu(e, t, o, n);
      else {
        o = d.getNode();
    ...
    xh = (e, t, n, o) => {
      const r = e.formatter.get(t),
        ...
        d = (e, t = s) => {
          if (
            (x(t.onformat) && t.onformat(e, t, n, o),
            yh(t.styles, (t, o) => {
              i.setStyle(e, o, Vc(t, n));
            }),
            t.styles)
          ) {
          ...
          yh(t.attributes, (t, o) => {
            i.setAttrib(e, o, Vc(t, n));
          }),
            yh(t.classes, (t) => {
              (t = Vc(t, n)), i.hasClass(e, t) || i.addClass(e, t);
            });
        },
        c = (e, t) => {
          let n = !1;
          return yh(e, (e) => !!Yc(e) && (C(e.collapsed) && e.collapsed !== a ? void 0 : i.is(t, e.selector) && !gc(t) ? (d(t, e), (n = !0), !1) : void 0)), n;
        },
        u = (e) => {
          if (m(e)) {
            const t = i.create(e);
        ...
        f = (o, a, i) => {
          ...
          fu(o, a, (a) => {
            ...
            const p = (a) => {
              ...
              if (
                (yo(a) && o.getContentEditable(a) && ((b = m), (m = "true" === o.getContentEditable(a)), (h = !0)),
                Do(a) &&
                  !((e, t, n, o) => {
                    if (pl(e) && Xc(t)) {
                ...
                return (u = null), void (Gc(s) && o.remove(a));
              if (Gc(s) && s.wrapper && Pp(e, a, t, n)) u = null;
              else {
                if (m && !h && Gc(s) && !s.wrapper && Uc(e, v) && zc(e, x, f)) {
                  const e = o.rename(a, f);
                  return d(e), l.push(e), void (u = null);
                }
                if (Yc(s)) {
                  let e = c(r, a);
                  if ((!e && C(y) && Qc(s) && (e = c(r, y)), !Xc(s) || e)) return void (u = null);
                }
                !m || h || !zc(e, f, v) || !zc(e, x, f) || (!i && No(a) && mr(a.data)) || gc(a) || (Xc(s) && o.isBlock(a)) ? ((u = null), $(de(a.childNodes), p), h && (m = b), (u = null)) : (u || ((u = o.clone(g, !1)), a.parentNode.insertBefore(u, a), l.push(u)), u.appendChild(a));
              }
            };
            $(a, p);
          }),
              ...
              (!(l.length > 1) && o.isBlock(a)) || 0 !== i
                ? (Xc(s) || (Gc(s) && s.wrapper)) &&
                  (s.exact ||
                    1 !== i ||
                    (a = ((e) => {
                      const t = Q(e.childNodes, Ch).filter((e) => Dp(o, e, s));
                      return t
                        .map((t) => {
                          const n = o.clone(t, !1);
                  ...
                  ((e, t, n, o) => {
                    vh(t, (t) => {
                      Xc(t) &&
                        vh(e.dom.select(t.inline, o), (o) => {
                          Jp(o) && ph(e, t, n, o, t.exact ? o : null);
                        }),
                        ((e, t, n) => {
                  ...
                  ((e, t, n, o, r) => {
                    (Pp(e, r.parentNode, n, o) && ph(e, t, o, r)) ||
      ...
      if ("false" !== i.getContentEditable(l.getNode())) {
        ...
        for (let e = 0, t = r.length; e < t; e++) {
          const t = r[e];
          if (t.ceFalseOverride && Yc(t) && i.is(o, t.selector)) {
            d(o, t);
            break;
          }
        }
    ...
    Sh = (e, t, n, o, r) =>
      X(
        ...
        (t) => !!Tp(e, t, n) || (!o && C(e.formatter.matchNode(t, n, r, !0)))
      ),
    _h = (e, t) => {
      const n = null != t ? t : kh(e);
      return K(Kc(e.dom, n), (e) => yo(e) && !ko(e));
    },
    Eh = (e, t, n) => {
      const o = _h(e, t);
      fe(n, (n, r) => {
  ...
  var Cb = function () {
    ...
    wb = (function e() {
      ...
      var x = xb(g, o),
        ...
        A = {};
      try {
        A = Qh(r).documentMode ? r.documentMode : {};
      } catch (e) {}
      var O = {};
      ...
      var T = cb,
        ...
        ke = function (e) {
          (Ce && Ce === e) ||
            ((e && "object" === (void 0 === e ? "undefined" : vb(e))) || (e = {}),
            (e = Qh(e)),
            (F = "ALLOWED_TAGS" in e ? Xh({}, e.ALLOWED_TAGS) : U),
            (z = "ALLOWED_ATTR" in e ? Xh({}, e.ALLOWED_ATTR) : j),
            (de = "ADD_URI_SAFE_ATTR" in e ? Xh(Qh(ce), e.ADD_URI_SAFE_ATTR) : ce),
            (ie = "ADD_DATA_URI_TAGS" in e ? Xh(Qh(le), e.ADD_DATA_URI_TAGS) : le),
            (se = "FORBID_CONTENTS" in e ? Xh({}, e.FORBID_CONTENTS) : ae),
            (H = "FORBID_TAGS" in e ? Xh({}, e.FORBID_TAGS) : {}),
            ($ = "FORBID_ATTR" in e ? Xh({}, e.FORBID_ATTR) : {}),
            ...
            (ge = e.NAMESPACE || fe),
            e.CUSTOM_ELEMENT_HANDLING && we(e.CUSTOM_ELEMENT_HANDLING.tagNameCheck) && (V.tagNameCheck = e.CUSTOM_ELEMENT_HANDLING.tagNameCheck),
            e.CUSTOM_ELEMENT_HANDLING && we(e.CUSTOM_ELEMENT_HANDLING.attributeNameCheck) && (V.attributeNameCheck = e.CUSTOM_ELEMENT_HANDLING.attributeNameCheck),
            ...
            (he = he = -1 === be.indexOf(e.PARSER_MEDIA_TYPE) ? ve : e.PARSER_MEDIA_TYPE),
            (ye =
            ...
            G && (W = !1),
            Z && (J = !0),
            re && ((F = Xh({}, [].concat(yb(sb)))), (z = []), !0 === re.html && (Xh(F, Zh), Xh(z, ab)), !0 === re.svg && (Xh(F, eb), Xh(z, ib), Xh(z, db)), !0 === re.svgFilters && (Xh(F, tb), Xh(z, ib), Xh(z, db)), !0 === re.mathMl && (Xh(F, ob), Xh(z, lb), Xh(z, db))),
            e.ADD_TAGS && (F === U && (F = Qh(F)), Xh(F, e.ADD_TAGS)),
            e.ADD_ATTR && (z === j && (z = Qh(z)), Xh(z, e.ADD_ATTR)),
            e.ADD_URI_SAFE_ATTR && Xh(de, e.ADD_URI_SAFE_ATTR),
            e.FORBID_CONTENTS && (se === ae && (se = Qh(se)), Xh(se, e.FORBID_CONTENTS)),
            ne && (F["#text"] = !0),
            Y && Xh(F, ["html", "head", "body"]),
            F.table && (Xh(F, ["tbody"]), delete H.tbody),
            Bh && Bh(e),
            (Ce = e));
        },
      ...
      var Ae = function (e) {
        ...
        Te = function (e, t) {
          try {
            jh(n.removed, { attribute: t.getAttributeNode(e), from: t });
          } catch (e) {
            jh(n.removed, { attribute: null, from: t });
          }
        ...
        Pe = function (e) {
          return "object" === (void 0 === i ? "undefined" : vb(i)) ? e instanceof i : e && "object" === (void 0 === e ? "undefined" : vb(e)) && "number" == typeof e.nodeType && "string" == typeof e.nodeName;
        },
        Me = function (e, t, o) {
          O[e] &&
            Uh(O[e], function (e) {
      ...
      return (
        (n.sanitize = function (e, r) {
          ...
          if (!n.isSupported) {
            if ("object" === vb(t.toStaticHTML) || "function" == typeof t.toStaticHTML) {
  ...
  const Ab = (e) => (e || "blobid") + Rb++,
    ...
    Pb = (e, t, n) => {
      ...
      return !e.allow_script_urls && (!!/((java|vb)script|mhtml):/i.test(o) || (!e.allow_html_data_urls && (/^data:image\//i.test(o) ? ((e, t) => (C(e) ? !e : !C(t) || !j(Lb, t)))(e.allow_svg_data_urls, n) && /^data:image\/svg\+xml/i.test(o) : /^data:/i.test(o))));
    };
  class Mb {
    constructor(e, t) {
  ...
  const Ib = Bt.makeMap,
        ...
        n.addHook("uponSanitizeElement", (n, s) => {
          ...
          if (!o || f) {
            if (((s.allowedTags[l] = !0), o && !c)) {
              if (
                ($(null !== (a = f.attributesForced) && void 0 !== a ? a : [], (e) => {
                ...
                f.attributesRequired && !V(f.attributesRequired, (e) => Gt(d, e)))
              )
                return void no(d);
              if (
                f.removeEmptyAttrs &&
                ...
                o = (e) => {
                  ...
                  ((e) => e.attr("src") === Nt.transparentSrc || C(e.attr("data-mce-placeholder")))(e) ||
                    ...
                    ((e) => {
                      ...
                      .bind(({ type: e, data: t }) =>
                        M.from(n.getByData(t, e)).orThunk(() =>
                          _b(e, t).map((e) => {
    ...
    Kb = (e, t) => {
      ...
      if (_p(e)) {
        if (o.content !== n) {
          const t = Wb({ validate: !1, forced_root_block: !1 }).parse(o.content, { context: e.name });
          return { ...o, content: t };
        }
        return { ...o, content: e };
      }
    ...
    Gb = (e, t) => {
      if (t.no_events) return di.value(t);
      {
        const n = ((e, t) => e.dispatch("BeforeGetContent", t))(e, t);
        return n.isDefaultPrevented() ? di.error(Iu(e, { content: "", ...n }).content) : di.value(n);
      }
    },
    ...
    Xb = (e, t) => {
      if (t.no_events) return di.value(t);
      {
        const n = Kb(t.content, (n) => ((e, t) => e.dispatch("BeforeSetContent", t))(e, { ...t, content: n }));
        return n.isDefaultPrevented() ? (Mu(e, n), di.error(void 0)) : di.value(n);
      }
    },
    Qb = (e, t, n) => {
      n.no_events || Mu(e, { ...n, content: t });
    },
    ...
    rv = (e, t) => {
      ...
      for (let e = 0; e < n.length; e++) {
        const o = n[e].cells;
        for (let n = 0; n < o.length; n++) if (bn(o[n], t)) return M.some(ev(n, e));
      }
      return M.none();
    },
    sv = (e, t, n, o, r) => {
            ...
            t.length > 0 && t[0].collapsed
              ...
              : ((e, t) =>
                  ((e, t) => {
                    ...
                    return t.length > 0 ? em([n]) : n;
                  })(mn(t.cloneContents()), iv(e, t)))(e, t[0]))(e, t);
    },
    ...
    bv = (e, t, n) => {
      ...
      "fragmented" === t.type ? gv(t.fragments, e.getBody()) : e.setContent(t.content, { format: "raw", no_selection: !C(o) || !hc(o) || !o.isFakeCaret }), e.selection.moveToBookmark(o);
    },
    vv = (e) => ("fragmented" === e.type ? e.fragments.join("") : e.content),
    yv = (e) => {
      const t = cn("body", pv());
      return ro(t, vv(e)), $(Xs(t, "*[data-mce-bogus]"), no), oo(t);
    },
    ...
    Sv = (e) => ({
      ...
      undoManager: {
        ...
        undo: (t, n, o) =>
          ((e, t, n, o) => {
            let r;
            return t.typing && (t.add(), (t.typing = !1), wv(t, !1, n)), o.get() > 0 && (o.set(o.get() - 1), (r = t.data[o.get()]), bv(e, r, !0), e.setDirty(!0), e.dispatch("Undo", { level: r })), r;
          })(e, t, n, o),
        redo: (t, n) =>
          ((e, t, n) => {
            let o;
            return t.get() < n.length - 1 && (t.set(t.get() + 1), (o = n[t.get()]), bv(e, o, !1), e.setDirty(!0), e.dispatch("Redo", { level: o })), o;
          })(e, t, n),
        clear: (t, n) =>
          ((e, t, n) => {
        ...
        closest: (t) =>
          ((e, t) => {
            ...
            return M.from(e.selection.getStart(!0))
              .bind((o) => Ap(mn(o), (n) => ce(t, (t) => ((t, n) => (Pp(e, t.dom, n) ? M.some(n) : M.none()))(n, t)), n))
              .getOrNull();
          })(e, t),
            ...
            ((e, t, n, o, r, s) => {
              ...
              $(n.split(","), (t) => {
                const n = xe(a, t).getOrThunk(() => {
                    const e = { withSimilar: { state: zs(!1), similar: !0, callbacks: [] }, withoutSimilar: { state: zs(!1), similar: !1, callbacks: [] }, withVars: [] };
                    return (a[t] = e), e;
                  }),
                  i = () => {
                    const n = _h(e);
                    return Sh(e, n, t, r, s).isSome();
                  };
                if (v(s)) {
            ...
            })(e, t, n, o, r, s),
            {
              unbind: () =>
                ((e, t, n) => {
                  ...
                  $(t.split(","), (e) =>
                    xe(o, e).each((t) => {
                      o[e] = { withSimilar: { ...t.withSimilar, callbacks: K(t.withSimilar.callbacks, (e) => e !== n) }, withoutSimilar: { ...t.withoutSimilar, callbacks: K(t.withoutSimilar.callbacks, (e) => e !== n) }, withVars: K(t.withVars, (e) => e.callback !== n) };
                    })
                  ),
                    e.set(o);
                })(t, n, o),
      ...
      editor: {
        getContent: (t) =>
          ((e, t) =>
            M.from(e.getBody()).fold(N("tree" === t.format ? new yf("body", 11) : ""), (n) =>
              ((e, t, n) => {
                let o;
                return (
                  (o =
                    "raw" === t.format
                      ? Bt.trim(kf(e.serializer, n.innerHTML))
                      : "text" === t.format
                      ? e.dom.isEmpty(n)
                        ? ""
                        : fr(n.innerText || n.textContent)
                      : "tree" === t.format
                  ...
                  "text" !== t.format && !ir(mn(n)) && m(o) ? Bt.trim(o) : o
                );
              })(e, t, n)
            ))(e, t),
        setContent: (t, n) =>
                ...
                _p(t)
                  ...
                  : ((e, t, n, o) => {
                      if (0 === n.length || /^\s+$/.test(n)) {
                        ...
                        const s = Ti(e);
                        return e.schema.isValidChild(t.nodeName.toLowerCase(), s.toLowerCase()) ? ((n = r), (n = e.dom.createHTML(s, Bi(e), n))) : n || (n = r), Ep(e, n, o.no_selection), { content: n, html: n };
                      }
                      {
                        "raw" !== o.format && (n = Rf({ validate: !1 }, e.schema).serialize(e.parser.parse(n, { isRootContent: !0, insert: !0 })));
                        const r = ir(mn(t)) ? n : Bt.trim(n);
                        return Ep(e, r, o.no_selection), { content: r, html: r };
                      }
                    })(e, o, t, n)
              )
              .getOr({ content: t, html: _p(n.content) ? "" : n.content }))(e, t, n),
        insertContent: (t, n) => Sp(e, t, n),
        addVisual: (t) =>
          ((e, t) => {
            const n = e.dom,
              o = C(t) ? t : e.getBody();
            v(e.hasVisual) && (e.hasVisual = Al(e)),
    ...
    Ov = (e, t, n, o) => {
      e.bind(
        (e) => (
          (o ? _g : Sg)(e.dom, o ? e.dom.length : 0),
          t.filter(zt).map((t) =>
            ((e, t, n, o) => {
              const r = e.dom,
                s = t.dom,
      ...
      const { selectorChangedWithUnbind: a } = ((e, t) => {
        ...
        c = () => {
          ...
          const l = (e, t, n) => {
            ...
            c = t.document;
          if (void 0 !== o.bookmark && !1 === nf(o)) {
            const e = Wm(o);
            if (e.isSome()) return e.map((e) => df(o, [e])[0]).getOr(c.createRange());
          }
          try {
        ...
        u = (e, t) => {
          let n;
          if (!((e) => !!e && Bv(e.startContainer) && Bv(e.endContainer))(e)) return;
          const a = d();
          ...
          !e.collapsed && e.startContainer === e.endContainer && a.setBaseAndExtent && e.endOffset - e.startOffset < 2 && e.startContainer.hasChildNodes() && ((n = e.startContainer.childNodes[e.startOffset]), n && "IMG" === n.tagName && (a.setBaseAndExtent(e.startContainer, e.startOffset, e.endContainer, e.endOffset), (a.anchorNode === e.startContainer && a.focusNode === e.endContainer) || a.setBaseAndExtent(n, 0, n, 1))), o.dispatch("AfterSetSelectionRange", { range: e, forward: t });
        },
        m = () => {
          const t = d(),
        ...
        })(s, e, o),
        {
          ...
          serialize: (n, a = {}) => {
            ...
            return "tree" === i.format
              ? c
              : ((e, t, n, o, r) => {
                  const s = ((e, t, n) => Rf(e, t).serialize(n))(t, n, o);
                  return ((e, t, n) => {
                    if (!t.no_events && e) {
    ...
    Iv = (e, t, n = {}) => {
      ...
      return Xb(e, o)
        .map((t) => {
          const n = ((e, t, n) => Ev(e).editor.setContent(t, n))(e, t.content, t);
          return Qb(e, n.html, t), n.content;
        })
        .getOr(t);
    },
    ...
    ty = (e) => {
      ...
      const n = () => {
        ...
        s = (n) => {
          e.editorManager.setActive(e), qm(e), e.ui.show();
          const o = n();
          return (
            ((n) => {
              t.push(n),
    ...
    ry = (e, t, n) => {
      Du(e, t, { message: n }), console.error(n);
    },
  ...
  const uy = (e, t) => {
    ...
    gy = (e) => {
      ...
      const r = dy(),
                    ...
                    s = H(n, (n, s) => {
                      ...
                      return (
                        n.status && Ui(e)
                          ...
                          : n.error &&
                            (n.error.remove && (c(i.getAttribute("src"), Nt.transparentSrc), r.push(i), (l = !0)),
                            ((e, t) => {
                              oy(e, $s.translate(["Failed to upload image: {0}", t]));
                            })(e, n.error.message)),
                        { element: i, status: n.status, uploadUri: n.url, blobInfo: a, removed: l }
                      );
                    });
                  return (
                    s.length > 0 && a.fireIfChanged(),
                    r.length > 0 &&
                      !_v(e) &&
                      e.undoManager.transact(() => {
                        $(r, (n) => {
        ...
        h = () => (
                  ...
                  const s = K(((e) => (e ? de(e.getElementsByTagName("img")) : []))(o), (t) => {
                    ...
                    a = H(s, (e) => {
                      ...
                      const o = new Promise((n, o) => {
                        ((e, t, n, o) => {
                          ...
                          if (0 === t.src.indexOf("blob:"))
                            return (
                              (s = e.getByUri(t.src)),
                              void (s
                                ? n({ image: t, blobInfo: s })
                                : Eb(t.src).then(
                                    (o) => {
                                      Nb(o).then((a) => {
                                        (r = Sb(a).data), (s = e.create(Ab(), o, r)), e.add(s), n({ image: t, blobInfo: s });
                                      });
                                    },
                                    (e) => {
                                      o(e);
                          ...
                          (r = a),
                            ...
                            s
                              ...
                              : Eb(t.src).then(
                                  (o) => {
                                    (s = e.create(Ab(), o, r)), e.add(s), n({ image: t, blobInfo: s });
                                  },
                                  (e) => {
                                    o(e);
                                  }
                        ...
                        .then((e) => (delete n[e.image.src], e))
                        .catch((t) => (delete n[e.src], t));
                      return (n[e.src] = o), o;
                    });
          ...
          o.findAll(e.getBody(), p).then(
            i(
              (t) => (
                (t = K(t, (t) => "string" != typeof t || (oy(e, t), !1))),
                _v(e) ||
                  $(t, (e) => {
      ...
      const s = (t && t.schema) || vs({}),
        ...
        i = (e, t, n) => {
          ...
          return (
            ...
            n &&
              (o || ((o = Cy.create("div")), o.appendChild(e)),
              Bt.each(n, (t) => {
                const n = a(t);
                o.insertBefore(n, e);
              })),
    ...
    ky = (e, t) => {
      ...
      return (
        ...
        Cy.setStyles(o, { position: "absolute", left: -65535 }),
        e.getBody().appendChild(o),
        (r = Cy.getStyle(e.getBody(), "fontSize", !0)),
    ...
    Sy = (e) => {
      const t = ((e) => {
            ...
            n = (e, o) => {
              e &&
                (m(e)
                  ? (p(o) || (o = [o]),
                    $(o, (e) => {
                      v(e.deep) && (e.deep = !Yc(e)), v(e.split) && (e.split = !Yc(e) || Xc(e)), v(e.remove) && Yc(e) && !Xc(e) && (e.remove = "none"), Yc(e) && Xc(e) && ((e.mixed = !0), (e.block_expand = !0)), m(e.classes) && (e.classes = e.classes.split(/\s+/));
                    }),
                    (t[e] = o))
                  : fe(e, (e, t) => {
                      n(t, e);
          ...
          return (
                ...
                const t = e.dom,
                  ...
                  o = {
                    ...
                    alignleft: [
                      ...
                      { selector: "figure,p,h1,h2,h3,h4,h5,h6,td,th,tr,div,ul,ol,li", styles: { textAlign: "left" }, inherit: !1, preview: !1 },
                    ...
                    aligncenter: [
                      { selector: "figure,p,h1,h2,h3,h4,h5,h6,td,th,tr,div,ul,ol,li", styles: { textAlign: "center" }, inherit: !1, preview: "font-family font-size" },
                    ...
                    alignright: [
                      ...
                      { selector: "figure,p,h1,h2,h3,h4,h5,h6,td,th,tr,div,ul,ol,li", styles: { textAlign: "right" }, inherit: !1, preview: "font-family font-size" },
            ...
            n(vy()),
            n(fl(e)),
            { get: (e) => (C(e) ? t[e] : t), has: (e) => we(t, e), register: n, unregister: (e) => (e && t[e] && delete t[e], t) }
          );
        })(e),
        n = zs(null);
      return (
          ...
          ((e, t, n) => {
            ...
            e.on("init", () => {
              ...
              e.on("keydown", (e) => {
                ...
                !(s < 16 || s > 20) || 224 === s || 91 === s || t.typing || a || (t.beforeChange(), wv(t, !0, n), t.add({}, e), o.set(!0));
              }),
              e.on("mousedown", (e) => {
                t.typing && r(e);
              }),
    ...
    By = (e, t) => pn(mn(t), nl(e)),
    Dy = (e, t, n) => {
      const o = ((e, t, n) => K(Is.DOM.getParents(n.container(), "*", t), e))(e, t, n);
    ...
    Xy = (e, t, n) => (
      ...
      ((e, t) =>
        vn(t, e)
          ...
          : M.none())(t, n).fold(O(Gy, e, t, n), O(Ky, e, t, n))
    ),
          ...
          n.collapsed
            ? ((e, t, n) => {
                const o = Hy(e, Ua.fromRangeStart(n)),
                  r = o.bind((n) =>
                    sc(t, e, n.position).bind((n) =>
                      Hy(e, n).map((n) =>
                        ((e, t, n) =>
                          Do(n.position.getNode()) && !1 === qr(n.block)
                            ? lc(!1, n.block.dom)
                                .bind((o) => (o.isEqual(n.position) ? sc(t, e, o).bind((t) => Hy(e, t)) : M.some(n)))
                                .getOr(n)
                            : n)(e, t, n)
                      )
                    )
                  );
                return Lt(o, r, Vy).filter(
                  (e) =>
                    ((e) => !1 === bn(e.from.block, e.to.block))(e) &&
                    ((e) =>
                      wn(e.from.block)
                        .bind((t) => wn(e.to.block).filter((e) => bn(t, e)))
                        .isSome())(e) &&
                    ((e) => !1 === Mo(e.from.block.dom) && !1 === Mo(e.to.block.dom))(e)
                );
              })(e, t, n)
            : M.none())(n.dom, t, e.selection.getRng()).map((o) => () => {
          Qy(n, t, o.from.block, o.to.block).each((t) => {
    ...
    eC = (e) => {
      ...
      return ((e, t) => {
        ...
        : ((e, t) => {
            const n = t.getRng();
            return Lt(zy(e, mn(n.startContainer)), zy(e, mn(n.endContainer)), (o, r) =>
              !1 === bn(o, r)
                ? M.some(() => {
                    n.deleteContents(),
                      Qy(e, !0, o, r).each((e) => {
      ...
      sc(t, e, n).bind((o) => {
        return (
          ...
          ((e, t, n, o) => {
            ...
            return Ud(!t, n).fold(() => Ud(t, o).fold(L, r), r);
          })(e, t, n, o)
            ? M.none()
            : (t && Mo(o.getNode())) || (!1 === t && Mo(o.getNode(!0)))
            ? ((e, t, n, o) => {
                const r = o.getNode(!1 === t);
                return zy(mn(e), mn(n.getNode()))
                  .map((e) => (qr(e) ? uC.remove(e.dom) : uC.moveToElement(r)))
                  .orThunk(() => M.some(uC.moveToElement(r)));
              })(e, t, n, o)
            : (t && Kf(n)) || (!1 === t && Wf(n))
            ? M.some(uC.moveToPosition(o))
            : M.none()
        );
        var r;
      }),
          ...
          () =>
            ((e, t, n) => {
              const o = Fd(t ? 1 : -1, e, n),
                ...
                s = mn(e);
              return !1 === t && Kf(r)
                ? M.some(uC.remove(r.getNode(!0)))
                : t && Wf(r)
                ? M.some(uC.remove(r.getNode()))
                : !1 === t && Wf(r) && dg(s, r)
                ? cg(s, r).map((e) => uC.remove(e.getNode()))
                : t && Kf(r) && lg(s, r)
                ? ug(s, r).map((e) => uC.remove(e.getNode()))
                : ((e, t, n) =>
                    ((e, t) => {
                      ...
                      ? ((e, t) => (e && Mo(t.nextSibling) ? M.some(uC.moveToElement(t.nextSibling)) : !1 === e && Mo(t.previousSibling) ? M.some(uC.moveToElement(t.previousSibling)) : M.none()))(t, n.getNode(!1 === t)).fold(() => mC(e, t, n), M.some)
                      : mC(e, t, n).bind((t) =>
                          ((e, t, n) =>
                            n.fold(
                              (e) => M.some(uC.remove(e)),
                              (e) => M.some(uC.moveToElement(e)),
                              (n) => (Td(t, n, e) ? M.none() : M.some(uC.moveToPosition(n)))
                            ))(e, n, t)
                        ))(e, t, r);
            })(e.getBody(), t, e.selection.getRng()).map(
              (n) => () =>
                n.fold(
                  ((e, t) => (n) => (e._selectionOverrides.hideFakeCaret(), Lg(e, t, mn(n)), !0))(e, t),
                  ((e, t) => (n) => {
    ...
    bC = (e, t) =>
      e.selection.isCollapsed()
        ? ((e, t) => {
            const n = Ua.fromRangeStart(e.selection.getRng());
            return sc(t, e.getBody(), n)
              .filter((e) => (t ? zf(e) : jf(e)))
              .bind((e) => M.from(Bd(t ? 0 : -1, e)))
    ...
    NC = (e, t) =>
      t.fold(
        (t) => {
          dd(e.get());
          const n = kC(t);
          return e.set(n), M.some(Ua(n, n.length - 1));
        },
        (t) =>
          uc(t).map((t) => {
    ...
    LC = (e, t, n) => {
      const o = My(n);
      return DC(e, t, o).bind((e) => (cc(e, o).isNone() ? M.some(AC.start(e)) : M.none()));
    },
    PC = (e, t, n) => {
      const o = Py(n);
      return DC(e, t, o).bind((e) => (dc(e, o).isNone() ? M.some(AC.end(e)) : M.none()));
    },
    MC = (e, t, n) => {
      const o = My(n),
        r = OC(t, o.container());
    ...
    IC = (e) => {
      return !1 === ((t = UC(e)), "rtl" === Is.DOM.getStyle(t, "direction", !0) || ((e) => Ty.test(e))(t.textContent));
      var t;
    },
    ...
    QC = (e, t, n, o) => {
      ...
      for (; s; ) {
        ...
        if (n.isVisible()) {
          if (e(s, n)) {
            const e = XC(0, t, s, n);
            return { positions: GC(t, a), breakType: e, breakAt: M.some(n) };
          }
          a.push(n), (s = n);
        } else s = n;
      }
    ...
    JC = (e, t, n, o) =>
      t(n, o)
        .breakAt.map((o) => {
          ...
          return e === $d.Backwards ? r.concat(o) : [o].concat(r);
        })
        .getOr([]),
    ZC = (e, t) =>
      Y(
        ...
        (e, n) =>
          e.fold(
            () => M.some(n),
            (o) =>
              Lt(ie(o.getClientRects()), ie(n.getClientRects()), (e, r) => {
  ...
  const mx = (e, t, n, o, r, s) => {
            ...
            .orThunk(() =>
              ((e, t, n, o, r) => {
                ...
                return sc(e, n, s)
                  ...
                  .fold(
                    () => o.map(jC),
                    (r) => FC(t, n, r).map(O(HC, e, t, n, s, r)).filter(O($C, o))
                  )
                  .filter(IC);
              })(e, t, n, s, o)
            );
    ...
    Tx = (e, t, n) => {
      if (ml(e)) {
        const o = xx(e, t).getOrThunk(() => {
          const n = e.selection.getRng();
          return t ? Ua.fromRangeEnd(n) : Ua.fromRangeStart(n);
        });
        return FC(O(By, e), e.getBody(), o).exists((t) => {
          const o = jC(t);
          return NC(n, o).exists((t) => (kx(e, t), !0));
        });
      }
      return !1;
    },
    ...
    Dx = (e, t, n, o) => {
      ...
      e.undoManager.ignore(() => {
        e.selection.setRng(
          ...
          Fy(e),
          FC(s, r, Ua.fromRangeStart(e.selection.getRng())).map(VC).bind(Bx(e, t)).each(D);
      }),
        e.nodeChanged();
    },
    Lx = (e, t, n) => {
      if (e.selection.isCollapsed() && ml(e)) {
        ...
        return ((e, t, n, o) => {
          const r = ((e, t) => Od(t, e) || e)(e.getBody(), o.container()),
            ...
            a = FC(s, r, o);
          return a
            .bind((e) => (n ? e.fold(N(M.some(VC(e))), M.none, N(M.some(jC(e))), M.none) : e.fold(M.none, N(M.some(jC(e))), M.none, N(M.some(VC(e))))))
            .map(Bx(e, t))
            .getOrThunk(() => {
              const i = ac(n, r, o),
                l = i.bind((e) => FC(s, r, e));
      ...
      e.selection.isCollapsed()
        ? ((e, t) => {
            ...
            return n(r)
              ...
              : M.from(Ly(t, r))
                  .filter((e) => n(e) && Hd(r, e))
                  .map((n) => () => Fx(e, t, n.getNode(!t)));
          })(e, t)
        : ((e, t) => {
            const n = e.selection.getNode();
            return Fo(n) ? Fx(e, t, n) : M.none();
          })(e, t),
    zx = (e) => {
    ...
    Hx = (e) => or(e) || rr(e),
    $x = (e) => {
      return K(((t = e.selection.getSelectedBlocks()), H(t, mn)), (e) => !Hx(e) && !((e) => wn(e).exists(Hx))(e) && $o(e, (e) => Po(e.dom) || Mo(e.dom)).exists((e) => Po(e.dom)));
      var t;
    },
    qx = (e, t) => {
      const { dom: n } = e,
    ...
    Yx = (e, t) => {
      e.addCommand("delete", () => {
        ...
        e.addCommand("forwardDelete", () => {
          ((e, t) => {
            Gx(e, t, !0).fold(() => ((e) => Iy(e, "ForwardDelete"))(e), D);
          })(e, t);
        });
    },
    ...
    rw = (e, t) => {
      const n = ((e) =>
        Wo(mn(e.getBody()), "*[data-mce-caret]")
          .map((e) => e.dom)
          .getOrNull())(e);
      if (n) return "compositionstart" === t.type ? (t.preventDefault(), t.stopPropagation(), void ow(e, n)) : void (yr(n) && (ow(e, n), e.undoManager.add()));
    },
    sw = Mo,
    aw = (e, t, n) => {
    ...
    Ew = (e, t) =>
      Sw(e, t).bind((t) => {
        const n = kw(t, "th,td", P);
        return J(n, (t) => bn(e, t)).map((e) => ({ index: e, all: n }));
      }),
    Nw = (e, t = !1) => {
      return zn(e) ? e.dom.isContentEditable : ((n = e), Ko(n, "[contenteditable]")).fold(N(t), (e) => "true" === Rw(e));
      var n;
    },
    ...
    Aw = (e, t, n, o, r) => {
      const s = Xs(mn(n), "td,th,caption").map((e) => e.dom),
        a = K(
          ((e, t) =>
            ee(t, (t) => {
              const n = ((e, t) => ({ left: e.left - t, top: e.top - t, right: e.right + -2, bottom: e.bottom + -2, width: e.width + t, height: e.height + t }))(ma(t.getBoundingClientRect()), -1);
              return [
    ...
    Bw = (e, t, n) => {
      const o = e(t, n);
      return ((e) => e.breakType === KC.Wrap && 0 === e.positions.length)(o) || (!Do(n.getNode()) && ((e) => e.breakType === KC.Br && 1 === e.positions.length)(o)) ? !((e, t, n) => n.breakAt.exists((n) => e(t, n).breakAt.isSome()))(e, t, o) : o.breakAt.isNone();
    },
    Dw = O(Bw, tx),
    Lw = O(Bw, nx),
    Pw = (e, t, n, o) => {
      ...
      return !(
        ...
        !((e, t, n) => {
          ...
          return lc(!e, n).exists((e) => e.isEqual(o));
        })(t, r, n) ||
        (rC(s, e, n, !t, !1).each((t) => {
          bx(e, t);
        }),
    ...
    Iw = (e, t, n, o) => {
      ...
      if (!t && Dw(o, s)) {
        const o = ((e, t, n) =>
          ((e, t) =>
            ie(t.getClientRects())
              .bind((t) => Ow(e, t.left, t.top))
              .bind((e) => {
                return ex(
                  mc((n = e))
                    .map((e) => tx(n, e).positions.concat(e))
                    .getOr([]),
                  t
                );
                var n;
              }))(t, n)
            .orThunk(() => ie(n.getClientRects()).bind((n) => ZC(ox(e, Ua.before(t)), n.left)))
            .getOr(Ua.before(t)))(a, n, s);
        return Mw(e, t, o), !0;
      }
      if (t && Lw(o, s)) {
        const o = ((e, t, n) =>
          ((e, t) =>
            le(t.getClientRects())
              .bind((t) => Tw(e, t.left, t.top))
              .bind((e) => {
                return ex(
                  uc((n = e))
                    .map((e) => [e].concat(nx(n, e).positions))
                    .getOr([]),
                  t
                );
                var n;
              }))(t, n)
            .orThunk(() => ie(n.getClientRects()).bind((n) => ZC(rx(e, Ua.after(t)), n.left)))
            .getOr(Ua.after(t)))(a, n, s);
        return Mw(e, t, o), !0;
      }
      return !1;
    },
    ...
    jw = (e, t, n) =>
      n.fold(
        ...
        (n) => (e.execCommand("mceTableInsertRowAfter"), Vw(e, t, n))
      ),
    Vw = (e, t, n) => {
      return jw(
        e,
    ...
    $w = (e, t) => {
      ...
      return ((e, t) => ((e, t, n = L) => (n(t) ? M.none() : j(e, Mt(t)) ? M.some(t) : qo(t, e.join(","), (e) => pn(e, "table") || n(e))))(["td", "th"], e, t))(mn(t ? s.endContainer : s.startContainer), r)
        .map(
          (n) => (
            Sw(n, r).each((t) => {
    ...
    Kw = (e) => (t) => e === t ? -1 : 0,
    Gw = (e, t, n) => {
      if (No(e) && t >= 0) return M.some(qw(e, t));
      {
        const o = ca(Ww);
        return M.from(o.backwards(e, t, Kw(e), n)).map((e) => qw(e.container, e.container.data.length));
      }
    },
    Yw = (e, t, n) => {
      if (!No(e)) return M.none();
      const o = e.textContent;
      if (t >= 0 && t <= o.length) return M.some(qw(e, t));
      {
        const o = ca(Ww);
        return M.from(o.backwards(e, t, Kw(e), n)).bind((e) => {
    ...
    Xw = (e, t, n) => {
      if (!No(e)) return M.none();
      const o = e.textContent;
      if (t <= o.length) return M.some(qw(e, t));
      {
        const r = ca(Ww);
        return M.from(r.forwards(e, t, Kw(e), n)).bind((e) => Xw(e.container, t - o.length, n));
      }
    },
    Qw = (e, t, n, o, r) => {
      const s = ca(
    ...
    tk = (e, t, n, o = 0) => {
      return ((r = mn(t.startContainer)), Ko(r, mf)).fold(
        () =>
          ((e, t, n, o = 0) => {
            ...
            return Qw(
              ...
              const s = Jw(r);
              return 0 !== s.lastIndexOf(n) || ek(s, n).length < o ? M.none() : M.some({ text: ek(s, n), range: r, triggerChar: n });
            });
          })(e, t, n, o),
        (t) => {
          const o = e.createRng();
    ...
    nk = (e) => {
      if (((e) => 3 === e.nodeType)(e)) return qw(e, e.data.length);
      {
        const t = e.childNodes;
        return t.length > 0 ? nk(t[t.length - 1]) : qw(e, t.length);
      }
    },
    ok = (e, t) => {
      const n = e.childNodes;
      return n.length > 0 && t < n.length ? ok(n[t], 0) : n.length > 0 && ((e) => 1 === e.nodeType)(e) && n.length === t ? nk(n[n.length - 1]) : qw(e, t);
    },
    rk = (e, t, n, o = {}) => {
      const r = t(),
        ...
        a = K(
          ...
          (t) =>
            ...
            t.matches.getOrThunk(() =>
              ((e) => (t) => {
                const n = ok(t.startContainer, t.startOffset);
                return !((e, t) =>
                  Qw(e, t.container, t.offset, (e, t) => (0 === t ? -1 : t), e.getRoot())
                    .filter((e) => {
  ...
  const ak = (e, t, n) => (e.stype === sk.Error ? t(e.serror) : n(e.svalue)),
    ...
    mk = (e, t) => ({
      extract: (n, o) =>
        xe(o, e).fold(
          () => ((e, t) => uk(e, () => 'Choice schema did not contain choice key: "' + t + '"'))(n, e),
          (e) =>
            ((e, t, n, o) =>
              xe(n, o).fold(
                () => ((e, t, n) => uk(e, () => 'The chosen schema: "' + n + '" did not exist in branches: ' + ck(t)))(e, n, o),
    ...
    vk = (e) => ({
      extract: (t, n) => {
        return (o = e(n)), (r = (e) => ((e, t) => uk(e, N(t)))(t, e)), o.stype === sk.Error ? r(o.serror) : o;
        var o, r;
      },
      toString: N("val"),
    }),
        ...
        a = (e) =>
          e.fold(
            ...
            (e) => {
              ...
              return (s = n), (a = M.some), s.stype === sk.Value ? { stype: sk.Value, svalue: a(s.svalue) } : s;
              var s, a;
            }
          );
      switch (e.tag) {
    ...
    Sk = (e, t, n) => {
      return (o = ((e, t, n) => ((e, t) => (e.stype === sk.Error ? { stype: sk.Error, serror: t(e.serror) } : e))(t.extract([e], n), (e) => ({ input: n, errors: e })))(e, t, n)), ak(o, di.error, di.value);
      var o;
    },
    _k = (e, t) => mk(e, ge(t, wk)),
    Ek = N(yk),
    ...
    jk = (e, t, n) =>
      Uk(
        ...
        t,
        ((e) => {
          return (t = (t) => (j(e, t) ? di.value(t) : di.error(`Unsupported value: "${t}", choose one of "${e.join(", ")}".`))), vk((e) => t(e).fold(lk, ik));
          var t;
        })(n)
      ),
    Vk = (e, t) => Uk(e, t, Ok),
  ...
  const mS = (e) => {
      const t = e.ui.registry.getAll().popups,
        n = ge(t, (e) => {
          return ((t = e), Sk("Autocompleter", nS, t)).fold((e) => {
            throw new Error(
              "Errors: \n" +
                ((e) => {
      ...
      const t = Ws(),
        ...
        a = (a) => {
          ((n) =>
            t
              .get()
              .map((t) => tk(e.dom, e.selection.getRng(), t.triggerChar).bind((t) => rk(e, s, t, n)))
              .getOrThunk(() =>
                ((e, t) => {
                  const n = t(),
                    o = e.selection.getRng();
    ...
    AS = (e, t) => {
      Ti(e).toLowerCase() === t.tagName.toLowerCase() &&
        ((e, t, n) => {
          const o = e.dom;
          M.from(n.style)
            .map(o.parseStyle)
    ...
    OS = (e, t) => {
      ...
      const u = e.dom,
        ...
        v = () => {
          (a = /^(H[1-6]|PRE|FIGURE)$/.test(d) && "HGROUP" !== w ? h(p) : h()), Mi(e) && ES(u, l) && u.isEmpty(s) ? (a = u.split(l, s)) : u.insertAfter(a, s), bS(e, a);
        };
      mm(u, g).each((e) => {
      ...
      "LI" !== w || C || ((s = l), (l = l.parentNode), (d = w)),
        /^(LI|DT|DD)$/.test(d) && u.isEmpty(s)
          ...
          : s !== e.getBody() &&
            (hr(s)
              ? ((a = Sr(s)), u.isEmpty(s) && SS(s), AS(e, a), bS(e, a))
              : b()
              ? v()
              : b(!0)
              ? ((a = s.parentNode.insertBefore(h(), s)), bS(e, _S(s, "HR") ? a : s))
              : ((n = ((e) => {
                  const t = e.cloneRange();
                ...
                u.isEmpty(s) && SS(s),
                a.normalize(),
                u.isEmpty(a) ? (u.remove(a), v()) : (AS(e, a), bS(e, a))),
            u.setAttrib(a, "id", ""),
    ...
    VS = (e) => (t, n) =>
      ((e) =>
        vS(e)
          ...
          .isSome())(t) === e,
    HS = (e, t) => (n, o) => {
      const r = ((e) => vS(e).fold(N(""), (e) => e.nodeName.toUpperCase()))(n) === e.toUpperCase();
      return r === t;
    },
    $S = (e) => HS("pre", e),
    qS = (e) => (t, n) => Oi(t) === e,
    ...
    XS = (e, t) => {
      ((e, t) => RC([YS([jS], zS.none()), YS([HS("summary", !0)], zS.br()), YS([$S(!0), qS(!1), KS], zS.br()), YS([$S(!0), qS(!1)], zS.block()), YS([$S(!0), qS(!0), KS], zS.block()), YS([$S(!0), qS(!0)], zS.br()), YS([VS(!0), KS], zS.br()), YS([VS(!0)], zS.block()), YS([WS], zS.br()), YS([KS], zS.br()), YS([GS], zS.block())], [e, !(!t || !t.shiftKey)]).getOr(zS.none()))(e, t).fold(
        () => {
          (C(t) && hS(e, "insertLineBreak").isDefaultPrevented()) || (FS(e, t), C(t) && pS(e, "insertLineBreak"));
        },
        () => {
          (C(t) && hS(e, "insertParagraph").isDefaultPrevented()) || (OS(e, t), C(t) && pS(e, "insertParagraph"));
        },
        S
      );
    },
    ...
    t_ = (e, t) => {
      const n = t.container(),
        o = t.offset();
      return No(n)
        ? (n.insertData(o, e), M.some(Ua(n, o + e.length)))
        : jd(t).map((n) => {
            const o = un(e);
    ...
    s_ = (e) => {
      ...
      if (e.selection.isCollapsed()) {
        const o = O(By, e),
          r = Ua.fromRangeStart(e.selection.getRng());
        return FC(o, e.getBody(), r)
          .bind(
            (
              (e) => (t) =>
                t.fold(
                  (t) => cc(e.dom, Ua.before(t)),
                  (e) => uc(e),
                  (e) => mc(e),
                  (t) => dc(e.dom, Ua.after(t))
                )
            )(n)
          )
          .map((o) => () => r_(n, t)(o).each(((e) => (t) => (e.selection.setRng(t.toRange()), e.nodeChanged(), !0))(e)));
      }
      return M.none();
    },
    a_ = (e) =>
      td(e)
        ? [
            { keyCode: Uu.TAB, action: pw($w, e, !0) },
            { keyCode: Uu.TAB, shiftKey: !0, action: pw($w, e, !1) },
          ]
        : [],
    i_ = (e) => {
      if ((e.addShortcut("Meta+P", "", "mcePrint"), fS(e), _v(e))) return zs(null);
      {
        ...
        return (
          ((e) => {
            e.on("keyup compositionstart", O(rw, e));
          })(e),
          ((e, t) => {
            e.on("keydown", (n) => {
              !1 === n.isDefaultPrevented() &&
                ((e, t, n) => {
                  ...
                  hw(
                    [
                      { keyCode: Uu.RIGHT, action: pw(iw, e, !0) },
                      { keyCode: Uu.LEFT, action: pw(iw, e, !1) },
                      { keyCode: Uu.UP, action: pw(lw, e, !1) },
                      { keyCode: Uu.DOWN, action: pw(lw, e, !0) },
                      { keyCode: Uu.RIGHT, action: pw(Uw, e, !0) },
                      { keyCode: Uu.LEFT, action: pw(Uw, e, !1) },
                      { keyCode: Uu.UP, action: pw(zw, e, !1) },
                      { keyCode: Uu.DOWN, action: pw(zw, e, !0) },
                      { keyCode: Uu.RIGHT, action: pw(vw, e, !0) },
                      { keyCode: Uu.LEFT, action: pw(vw, e, !1) },
                      { keyCode: Uu.UP, action: pw(yw, e, !1) },
                      { keyCode: Uu.DOWN, action: pw(yw, e, !0) },
                      { keyCode: Uu.RIGHT, action: pw(Ex, e, t, !0) },
                      { keyCode: Uu.LEFT, action: pw(Ex, e, t, !1) },
                      { keyCode: Uu.RIGHT, ctrlKey: !o.isMacOS(), altKey: o.isMacOS(), action: pw(Ax, e, t) },
                      { keyCode: Uu.LEFT, ctrlKey: !o.isMacOS(), altKey: o.isMacOS(), action: pw(Ox, e, t) },
                      { keyCode: Uu.UP, action: pw(mw, e, !1) },
                      { keyCode: Uu.DOWN, action: pw(mw, e, !0) },
                    ],
                    n
                  ).each((e) => {
                    n.preventDefault();
            ...
            e.on("keydown", (n) => {
              !1 === n.isDefaultPrevented() &&
                ((e, t, n) => {
                  ...
                  bw(
                    [
                      { keyCode: Uu.BACKSPACE, action: pw(Kx, e) },
                      { keyCode: Uu.BACKSPACE, action: pw(hC, e, !1) },
                      { keyCode: Uu.DELETE, action: pw(hC, e, !0) },
                      { keyCode: Uu.BACKSPACE, action: pw(cC, e, !1) },
                      { keyCode: Uu.DELETE, action: pw(cC, e, !0) },
                      { keyCode: Uu.BACKSPACE, action: pw(Lx, e, t, !1) },
                      { keyCode: Uu.DELETE, action: pw(Lx, e, t, !0) },
                      { keyCode: Uu.BACKSPACE, action: pw(ap, e, !1) },
                      { keyCode: Uu.DELETE, action: pw(ap, e, !0) },
                      { keyCode: Uu.BACKSPACE, action: pw(bC, e, !1) },
                      { keyCode: Uu.DELETE, action: pw(bC, e, !0) },
                      { keyCode: Uu.BACKSPACE, action: pw(Ux, e, !1) },
                      { keyCode: Uu.DELETE, action: pw(Ux, e, !0) },
                      { keyCode: Uu.BACKSPACE, action: pw(tC, e, !1) },
                      { keyCode: Uu.DELETE, action: pw(tC, e, !0) },
                      { keyCode: Uu.BACKSPACE, action: pw(Jy, e, !1) },
                      { keyCode: Uu.DELETE, action: pw(Jy, e, !0) },
                      { keyCode: Uu.BACKSPACE, action: pw(Ix, e, !1) },
                      { keyCode: Uu.DELETE, action: pw(Ix, e, !0) },
                    ],
                    n
                  ).each((t) => {
              ...
              e.on("keyup", (t) => {
                !1 === t.isDefaultPrevented() &&
                  ((e, t) => {
                    hw(
                      [
                        { keyCode: Uu.BACKSPACE, action: pw(pC, e) },
                        { keyCode: Uu.DELETE, action: pw(pC, e) },
                      ],
                      t
                    );
                  })(e, t);
          ...
          ((e) => {
            e.on("keydown", (t) => {
              !1 === t.isDefaultPrevented() &&
                ((e, t) => {
                  bw([{ keyCode: Uu.SPACEBAR, action: pw(s_, e) }], t).each((n) => {
                    t.preventDefault(), hS(e, "insertText", { data: " " }).isDefaultPrevented() || (n(), pS(e, "insertText", { data: " " }));
                  });
                })(e, t);
            });
          })(e),
            ...
            e.on("input", (t) => {
              !1 === t.isComposing &&
                ((e) => {
                  const t = mn(e.getBody());
                  e.selection.isCollapsed() &&
                    wg(t, Ua.fromRangeStart(e.selection.getRng())).each((t) => {
                      e.selection.setRng(t.toRange());
                    });
                })(e);
            });
            ...
            e.on("keydown", (n) => {
              !1 === n.isDefaultPrevented() &&
                ((e, t, n) => {
                  hw(
                    [
                      { keyCode: Uu.END, action: pw(dw, e, !0) },
                      { keyCode: Uu.HOME, action: pw(dw, e, !1) },
                      { keyCode: Uu.END, action: pw(Cw, e, !0) },
                      { keyCode: Uu.HOME, action: pw(Cw, e, !1) },
                      { keyCode: Uu.END, action: pw(Tx, e, !0, t) },
                      { keyCode: Uu.HOME, action: pw(Tx, e, !1, t) },
                    ],
                    n
                  ).each((e) => {
                    n.preventDefault();
              ...
              e.on("keyup", (o) => {
                !1 === o.isDefaultPrevented() &&
                  ((e, t, n) => {
                    hw(
                      [
                        { keyCode: Uu.PAGE_UP, action: pw(Tx, e, !1, t) },
                        { keyCode: Uu.PAGE_DOWN, action: pw(Tx, e, !0, t) },
                      ],
                      n
                    );
                  })(e, t, o),
                  ZS(o) && n.get() && (e_(n, e, !1), e.nodeChanged());
              });
          })(e, t),
          t
        );
  ...
  const d_ = N("x-tinymce/html"),
    ...
    k_ = (e, t, n) =>
      !!((e, t) => x_(t) && V(ed(e), (e) => je(t.toLowerCase(), `.${e.toLowerCase()}`)))(e, t) &&
      ((e, t, n) => (
        e.undoManager.extra(
          () => {
            n(e, t);
    ...
    T_ = (e, t, n) => {
      ...
      if (zl(e) && o) {
        ...
        if (s.length > 0)
          return (
            t.preventDefault(),
            ((r = s), Promise.all(H(r, (e) => Nb(e).then((t) => ({ file: e, uri: t }))))).then((t) => {
              n && e.selection.setRng(n),
                $(t, (t) => {
                  ((e, t) => {
                    const { data: n, type: o } = Sb(t.uri),
                      r = t.file,
                      s = e.editorUpload.blobCache,
                      a = s.getByData(n, o),
                      i =
                        null != a
                          ? a
      ...
      ((e, t, n) => {
        ...
        e.on("keydown", (e) => {
          ...
          e.on("paste", (r) => {
            ...
            (!O_(a) && T_(e, r, t.getLastRng() || e.selection.getRng())) ||
              (A_(a, "text/html")
                ? (r.preventDefault(), B_(e, a, a["text/html"], s))
                : (t.create(),
                  Gm.setEditorTimeout(
                    e,
                    () => {
        ...
        ((e, t) => {
          e.addCommand("mceTogglePlainTextPaste", () => {
            ...
            e.addCommand("mceInsertClipboardContent", (t, n) => {
              n.html && E_(e, n.html, n.internal), n.text && N_(e, n.text);
            });
        })(e, n),
        ((e) => {
          const t = (t) => (n) => {
          ...
          ((e) => {
            e.on(
              ...
              e.on(
                "copy",
                ((e) => (t) => {
                  !t.isDefaultPrevented() && I_(e) && L_(t, M_(e), P_(e), S);
                })(e)
              );
          })(e),
            ((e, t) => {
              Ul(e) &&
                ...
                e.on("dragover dragend", (n) => {
                  zl(e) && !1 === t.get() && (n.preventDefault(), U_(e, F_(e, n))), "dragend" === n.type && t.set(!1);
                });
            })(e, t),
            D_(e, o, n);
        });
  ...
  const W_ = (e, t) => Math.abs(e.left - t),
    ...
    Q_ = (e, t, n) =>
      ((e, t, n) => {
        ...
        .filter((e) => bd(e.node))
        .map((e) => ((e, t) => ({ node: e.node, position: W_(e, t) < K_(e, t) ? q_.Before : q_.After }))(e, t)),
    J_ = (e) => {
      const t = e.getBoundingClientRect(),
        n = e.ownerDocument,
        o = n.documentElement,
      ...
      const t = Ws(),
              ...
              e.on((e) => {
                ...
                if (e.dragging) {
                  const r = ((e, t) => ({ pageX: t.pageX - e.relX, pageY: t.pageY + 5 }))(
                    ...
                    ((e, t) => {
                      return (
                        (n = ((e) => (e.inline ? J_(e.getBody()) : { left: 0, top: 0 }))(e)),
                        (o = ((e) => {
                          const t = e.getBody();
        ...
        a = ((e, t) => (n) => {
          e.on((e) => {
            if (e.dragging) {
              if (
                ((e, t, n) => t !== n && !e.dom.isChildOf(t, n) && !Z_(t))(
                  t,
                  ((e) => {
                ...
                t.dispatch("drop", { clientX: n.clientX, clientY: n.clientY }).isDefaultPrevented() ||
                  t.undoManager.transact(() => {
                    nE(e.element), t.insertContent(t.dom.getOuterHTML(o)), t._selectionOverrides.hideFakeCaret();
                  });
              }
              t.dispatch("dragend");
            }
            ...
            if (d(o))
              return ((o) => {
                ...
                const d = ((o, r) => {
                  ...
                  c = mn(o);
                return (
                  $(Xs(mn(e.getBody()), "*[data-mce-selected]"), (e) => {
                    bn(c, e) || Yt(e, i);
                  }),
      ...
      return (
        _v(e) ||
          ...
          e.on("mousedown", (o) => {
              ...
              ((e, t, n) => {
                const o = mn(e.getBody()),
                  ...
                  s = ((e, t, n, o) => {
                    ...
                    return { x: n - (e ? r.left + t.dom.clientLeft + Qv(t) : 0), y: o - (e ? r.top + t.dom.clientTop + Xv(t) : 0) };
                  })(e.inline, r, t, n);
                return ((e, t, n) => {
                  const o = Gv(e),
                    r = Yv(e);
            ...
            const a = aE(e, s);
            sE(a)
              ? (o.preventDefault(), sC(e, a).each(g))
              : Q_(r, o.clientX, o.clientY).each((n) => {
                  var r;
                  o.preventDefault(), (r = c(1, n.node, n.position === q_.Before, !1)) && t.setRng(r), yo(a) ? a.focus() : e.getBody().focus();
                });
          }),
          e.on("keypress", (e) => {
            Uu.modifierPressed(e) || (sE(t.getNode()) && e.preventDefault());
          }),
    ...
    uE = (e, t) =>
      cE(e, t.start).bind(({ node: n, offset: o }) =>
        cE(e, t.end).map(({ node: e, offset: t }) => {
          const r = document.createRange();
    ...
    pE = (e, t, n) => {
      ((e, t, n) => {
        if (No(e) && 0 >= e.length) return M.some(qw(e, 0));
        {
          const t = ca(Ww);
          return M.from(t.forwards(e, 0, Kw(e), n)).map((e) => qw(e.container, 0));
        }
      })(t, 0, t).each((o) => {
        const r = o.container;
    ...
    wE = (e, t, n) => {
      ...
      return Yw(a, i - n.pattern.end.length, t).bind((l) => {
        ...
        if (CE(s)) return M.some({ matches: [{ pattern: s, startRng: d, endRng: d }], position: l });
        {
          ...
          return u.map((e) => {
            const t = ((e, t) => dE(e, t.startContainer, t.startOffset, t.endContainer, t.endOffset))(r, e);
            return { matches: i.matches.concat([{ pattern: s, startRng: t, endRng: d }]), position: qw(e.startContainer, e.startOffset) };
          });
        }
      });
    },
      ...
      return !1 === o.collapsed
        ...
        : gE(e, o)
            .bind((r) => {
              ...
              return kE(e, t, o.startContainer, s, r);
            })
            .fold(
              () => [],
              (e) => e.matches
                      ...
                      gE(e, r).each((t) => {
                        "block-format" === o.type
                          ? ((e, t) => {
                            ...
                            e.undoManager.transact(() => {
                              pE(e.dom, t, o), e.formatter.apply(o.format);
                            })
                          : "block-command" === o.type &&
                            e.undoManager.transact(() => {
                              pE(e.dom, t, o), e.execCommand(o.cmd, !1, o.value);
                            });
                      }),
                      !0
                    );
    ...
    OE = (e) => {
      ...
      e.on(
        ...
        e.on("keyup", (t) => {
          AE(n, t, (e, t) => e === t.keyCode && !1 === Uu.modifierPressed(t)) && RE(e, o());
        }),
        e.on("keypress", (n) => {
          AE(t, n, (e, t) => e.charCodeAt(0) === t.charCode) &&
            Gm.setEditorTimeout(e, () => {
              RE(e, o());
            });
        });
    ...
    TE = (e) => {
      const t = Bt.each,
        ...
        y = () => {
          Sl(e) ||
            e.on("BeforeExecCommand mousedown", () => {
              m("StyleWithCSS", !1), m("enableInlineTableEditing", !1), ol(e) || m("enableObjectResizing", !1);
            });
        },
        C = () => {
        ...
        k = () => {
          u &&
            e.on("keydown", (t) => {
              !Uu.metaKeyPressed(t) || t.shiftKey || (37 !== t.keyCode && 39 !== t.keyCode) || (t.preventDefault(), e.selection.getSel().modify("move", 37 === t.keyCode ? "backward" : "forward", "lineboundary"));
            });
        },
        _ = () => {
          e.on("click", (e) => {
          ...
          : (e.on("keydown", (t) => {
            ...
            Nt.windowsPhone ||
              e.on(
                ...
                (e) => {
                  Uu.modifierPressed(e) || s.normalize();
                },
                !0
              ),
            d &&
              ...
              b(),
              e.on("init", () => {
                m("DefaultParagraphSeparator", Ti(e));
              }),
              E(),
              v(),
    ...
    ME = (e) => {
      const t = e.options.get;
      return LE({ custom_elements: t("custom_elements"), extended_valid_elements: t("extended_valid_elements"), invalid_elements: t("invalid_elements"), invalid_styles: t("invalid_styles"), schema: t("schema"), valid_children: t("valid_children"), valid_classes: t("valid_classes"), valid_elements: t("valid_elements"), valid_styles: t("valid_styles"), verify_html: t("verify_html") });
    },
    ...
    UE = (e) => {
      !0 !== e.removed &&
        (((e) => {
          _v(e) || e.load({ initial: !0, format: "html" }), (e.startContent = e.getContent({ format: "raw" }));
        })(e),
        ((e) => {
    ...
    zE = (e) => {
      ...
      (o.disabled = !0),
        (e.readonly = Sl(e)),
        e.readonly || (e.inline && "static" === BE.getStyle(o, "position", !0) && (o.style.position = "relative"), (o.contentEditable = "true")),
        (o.disabled = !1),
        (e.editorUpload = gy(e)),
        (e.schema = vs(ME(e))),
        (e.dom = Is(n, {
        ...
        (e.serializer = Mv(
          ((e) => {
            const t = e.options.get;
            return { ...PE(e), ...ME(e), ...LE({ url_converter: t("url_converter"), url_converter_scope: t("url_converter_scope"), element_format: t("element_format"), entities: t("entities"), entity_encoding: t("entity_encoding"), indent: t("indent"), indent_after: t("indent_after"), indent_before: t("indent_before") }) };
          })(e),
          e
        )),
        (e.selection = Dv(e.dom, e.getWin(), e.serializer, e)),
        (e.annotator = Ou(e)),
        (e.formatter = Sy(e)),
        (e.undoManager = Ey(e)),
        (e._nodeChangeDispatcher = new l_(e)),
        (e._selectionOverrides = iE(e)),
        ((e) => {
          const t = Ws(),
            n = zs(!1),
            o = Gs((t) => {
      ...
      Yx(e, r),
        ...
        ((e) => {
            ...
            r = (s, a) => {
              if (
                ((e) => {
                  if (Ay(e)) {
                    const t = e.keyCode;
                    return !Oy(e) && (Uu.metaKeyPressed(e) || e.altKey || (t >= 112 && t <= 123) || j(Ny, t));
                  }
                  return !1;
                })(s)
              )
              ...
              const i = e.getBody(),
                l =
                  !((e) => Ay(e) && !(Oy(e) || ("keyup" === e.type && 229 === e.keyCode)))(s) &&
                  ((e, t, n) => {
                    if (qr(mn(t), !1)) {
              ...
              (("" !== t.getAttrib(i, Ry)) !== l || a) &&
                (t.setAttrib(i, Ry, l ? o : null),
          ...
          o &&
            e.on("init", (t) => {
              r(t, !0), e.on("change SetContent ExecCommand", r), e.on("paste", (t) => Gm.setEditorTimeout(e, () => r(t)));
            });
        })(e),
        H_(e);
      const s = ((e) => {
        const t = e;
        return ((e) => xe(e.plugins, "rtc").bind((e) => M.from(e.setup)))(e).fold(
          () => ((t.rtcInstance = Sv(e)), M.none()),
          (e) => (
            (t.rtcInstance = (() => {
              const e = N(null),
                t = N("");
      ...
      ((e) => {
        ...
        ((e) => {
          ...
          Il(e) || ((t.body.spellcheck = !1), BE.setAttrib(n, "spellcheck", "false")),
          (e.quirks = TE(e)),
          ((e) => {
          ...
          (t) => {
            e.setProgressState(!0),
              FE(e).then(() => {
                t().then(
                  (t) => {
                    e.setProgressState(!1), UE(e), Rv(e);
                  },
                  (t) => {
                    e.notificationManager.open({ type: "error", text: String(t) }), UE(e), Rv(e);
                  }
                );
              });
          }
    ...
    WE = (e) => {
      ...
      return (
        ...
        ((e) => {
          e.contentCSS = e.contentCSS.concat(((e) => iy(e, Ji(e)))(e), ((e) => iy(e, el(e)))(e));
        })(e),
        e.inline
          ? jE(e)
          : ((e, t) => {
              ((e, t) => {
                const n = e.translate("Rich Text Area"),
                  ...
                  r = ((e, t, n, o) => {
                    const r = cn("iframe");
                    return o.each((e) => $t(r, "tabindex", e)), qt(r, n), qt(r, { id: e + "_ifr", frameBorder: "0", allowTransparency: "true", title: t }), nn(r, "tox-edit-area__iframe"), r;
                  })(e.id, n, Si(e), o).dom;
                (r.onload = () => {
                  ...
                  VE.add(t.iframeContainer, r);
              })(e, t),
                t.editorContainer && ((VE.get(t.editorContainer).style.display = e.orgDisplay), (e.hidden = VE.isHidden(t.editorContainer))),
                (e.getElement().style.display = "none"),
                VE.setAttrib(e.id, "aria-hidden", "true"),
                jE(e);
            })(e, n)
      );
    },
    ...
    XE = (e, t) => {
      ...
      ((e, t) => {
        ...
        ((e, t, n) => {
          const o = YE(t, "default", n),
            r = ((e) =>
              M.from(ji(e))
                .filter(We)
                .map((e) => ({ url: e, name: M.none() })))(t).orThunk(() => YE(t, zi(t), ""));
          $(
            ((e) => {
              const t = [],
                n = (e) => {
        ...
        ((e, t) => {
          ...
          fe(Nl(e), (t, o) => {
            n(o, t), e.options.set("plugins", El(e).concat(o));
          }),
            $(El(e), (e) => {
              !(e = Bt.trim(e)) || Zv.urls[e] || GE(e) || n(e, `plugins/${e}/plugin${t}.js`);
            });
        })(e, t),
      ...
      const a = e ? { mobile: oN(null !== (s = r.mobile) && void 0 !== s ? s : {}, t) } : {},
        ...
        l = Bt.extend(
          ...
          ((e, t) => e && nN(t, "mobile"))(e, i)
            ...
            : {},
          { external_plugins: rN(o, i.options()) }
        );
      return ((e, t, n, o) => {
      ...
      M.from(n)
        ...
        .bind((n) =>
          ((e, t, n) =>
            Ap(
              mn(n),
              (t) => ((t) => Wn(t, e).orThunk(() => ("font" === Mt(t) ? xe(dN, e).bind((e) => Kt(t, e)) : M.none())))(t),
              (e) => bn(mn(t), e)
            ))(e, t, n.dom).or(((e, t) => M.from(Is.DOM.getStyle(t, e, !0)))(e, n.dom))
        )
        .getOr(""),
    uN = cN("font-size"),
      ...
      aN(e),
        ...
        ((e) => {
          e.editorCommands.addCommands({
            ...
            insertImage: (t, n, o) => {
              lN(e, e.dom.createHTML("img", { src: o }));
            },
        ...
        ((e) => {
          ((e) => {
            ...
            e.editorCommands.addCommands({
              ...
              FontSize: (t, n, o) => {
                ((e, t) => {
                  e.formatter.toggle("fontsize", { value: pN(e, t) }), e.nodeChanged();
                })(e, o);
              },
              LineHeight: (t, n, o) => {
                ((e, t) => {
            ...
            ((e) => {
              ...
              e.editorCommands.addCommands({ "Bold,Italic,Underline,Strikethrough,Superscript,Subscript": (e) => t(e), mceBlockQuote: () => t("blockquote") }, "state"),
                e.editorCommands.addQueryValueHandler("FontName", () => ((e) => gN(e, (t) => mN(e.getBody(), t.dom)).getOr(""))(e)),
                e.editorCommands.addQueryValueHandler("FontSize", () => ((e) => gN(e, (t) => uN(e.getBody(), t.dom)).getOr(""))(e)),
  ...
  const yN = "data-mce-contenteditable",
      ...
      ((e, t, n) => {
        ...
        t
          ? (e.selection.controlSelection.hideResizeRect(),
            ...
            (e.readonly = !0),
            xN(n, !1),
            $(Xs(n, '*[contenteditable="true"]'), (e) => {
              $t(e, yN, "true"), xN(e, !1);
            }))
          : ((e.readonly = !1),
            xN(n, !0),
            $(Xs(n, '*[data-mce-contenteditable="true"]'), (e) => {
              Yt(e, yN), xN(e, !0);
            }),
            CN(e, "StyleWithCSS", !1),
            CN(e, "enableInlineTableEditing", !1),
            CN(e, "enableObjectResizing", !1),
            ((e) =>
              nf(e) ||
              ((e) => {
                const t = Pn(mn(e.getElement()));
    ...
    SN = (e) => {
      e.parser.addAttributeFilter("contenteditable", (t) => {
        ...
        e.serializer.addAttributeFilter(yN, (t) => {
          kN(e) &&
            $(t, (e) => {
              e.attr("contenteditable", e.attr(yN));
            });
        }),
        e.serializer.addTempAttr(yN);
    },
  ...
  const TN = (e, t) => {
    ...
    LN = {
      ...
      toggleNativeEvent(e, t) {
        const n = this;
        "focus" !== e && "blur" !== e && (n.removed || (t ? (n.initialized ? DN(n, e) : n._pendingNativeEvents ? n._pendingNativeEvents.push(e) : (n._pendingNativeEvents = [e])) : n.initialized && (n.dom.unbind(TN(n, e), e, n.delegates[e]), delete n.delegates[e])));
      },
    ...
    zN = (e, t, n, o) => {
      ...
      r.deactivate(),
        r.editorReadOnly !== s.editorReadOnly && wN(e, s.editorReadOnly),
        t.set(o),
        ((e, t) => {
  ...
  class QN {
    constructor(e, t, n) {
      ...
      (this.options = ((e, t) => {
        const n = {},
          ...
          r = (e, t, n) => {
            const r = FN(t, n);
            return IN(r) ? ((o[e] = r.value), !0) : (console.warn(MN(`Invalid value passed for the ${e} option`, r)), !1);
          },
          s = (e) => we(n, e);
        return {
          register: (e, s) => {
        ...
        ((e) => {
          ...
          t("id", { processor: "string", default: e.id }),
            ...
            t("body_id", { processor: ki(e, "tinymce"), default: "tinymce" }),
            t("body_class", { processor: ki(e), default: "" }),
            ...
            t("end_container_on_empty_block", { processor: "boolean", default: !1 }),
            ...
            t("indent_before", { processor: "string", default: "p,h1,h2,h3,h4,h5,h6,blockquote,div,title,style,pre,script,td,th,ul,ol,li,dl,dt,dd,area,table,thead,tfoot,tbody,tr,section,summary,article,hgroup,aside,figure,figcaption,option,optgroup,datalist" }),
            t("indent_after", { processor: "string", default: "p,h1,h2,h3,h4,h5,h6,blockquote,div,title,style,pre,script,td,th,ul,ol,li,dl,dt,dd,area,table,thead,tfoot,tbody,tr,section,summary,article,hgroup,aside,figure,figcaption,option,optgroup,datalist" }),
            t("indent_use_margin", { processor: "boolean", default: !1 }),
            t("indentation", { processor: "string", default: "40px" }),
            t("content_css", {
              processor: (e) => {
                const t = !1 === e || m(e) || k(e, m);
                return t ? (m(e) ? { value: H(e.split(","), He), valid: t } : p(e) ? { value: e, valid: t } : !1 === e ? { value: [], valid: t } : { value: e, valid: t }) : { valid: !1, message: "Must be false, a string or an array of strings." };
              },
              default: bl(e) ? [] : ["default"],
            }),
            ...
            t("inline_boundaries_selector", { processor: "string", default: "a[href],code,.mce-annotation" }),
            t("object_resizing", {
              processor: (e) => {
                const t = b(e) || m(e);
                return t ? (!1 === e || bi.isiPhone() || bi.isiPad() ? { value: "", valid: t } : { value: !0 === e ? "table,img,figure.image,div,video,iframe" : e, valid: t }) : { valid: !1, message: "Must be boolean or a string" };
              },
              default: !vi,
            }),
            ...
            t("theme", { processor: (e) => !1 === e || m(e) || x(e), default: "silver" }),
            ...
            t("invalid_styles", { processor: wi }),
            t("valid_children", { processor: "string" }),
            t("valid_classes", { processor: wi }),
            t("valid_elements", { processor: "string" }),
            t("valid_styles", { processor: wi }),
            ...
            t("text_patterns", {
              processor: (e) => (k(e, f) || !1 === e ? { value: hi(!1 === e ? [] : e), valid: !0 } : { valid: !1, message: "Must be an array of objects or false." }),
              default: [
            ...
            t("noneditable_regexp", { processor: (e) => (k(e, Ci) ? { value: e, valid: !0 } : Ci(e) ? { value: [e], valid: !0 } : { valid: !1, message: "Must be a RegExp or an array of RegExp." }), default: [] }),
            t("table_tab_navigation", { processor: "boolean", default: !0 }),
            e.on("ScriptsLoaded", () => {
              t("directionality", { processor: "string", default: $s.isRtl() ? "rtl" : void 0 }), t("placeholder", { processor: "string", default: yi.getAttrib(e.getElement(), "placeholder") });
            });
        })(o);
      ...
      d && (Nt.cacheSuffix = d.replace(/^[\?\&]+/, "")),
        (this.ui = { registry: KN(), styleSheetLoader: void 0, show: S, hide: S, setEnabled: S, isEnabled: P }),
        (this.mode = ((e) => {
          const t = zs("design"),
          ...
          return (
            ...
            })(e),
            {
              ...
              register: (e, t) => {
                n.set(
                  ((e, t, n) => {
                    if (j(UN, t)) throw new Error(`Cannot override default mode ${t}`);
                    return {
                      ...e,
                      [t]: {
                        ...n,
    ...
    render() {
      ((e) => {
        ...
        $s.setCode(Gi(e));
        const n = () => {
          KE.unbind(window, "ready", n), e.render();
        };
        ...
        e.on("remove", () => {
          ...
          (e.ui.styleSheetLoader = ((e, t) => Yo.forElement(e, { contentCssCors: _l(t), referrerPolicy: Ki(t) }))(o, e)),
          bl(e) ? (e.inline = !0) : ((e.orgVisibility = e.getElement().style.visibility), (e.getElement().style.visibility = "hidden"));
        const s = e.getElement().form || KE.getParent(t, "form");
        s &&
          ((e.formElement = s),
          vl(e) && !Eo(e.getElement()) && (KE.insertAfter(KE.create("input", { type: "hidden", name: t }), t), (e.hasHiddenInput = !0)),
          (e.formEventDelegate = (t) => {
            e.dispatch(t.type, t);
          }),
          KE.bind(s, "submit reset", e.formEventDelegate),
          e.on("reset", () => {
            e.resetContent();
          }),
          !yl(e) || s.submit.nodeType || s.submit.length || s._mceOldSubmit || ((s._mceOldSubmit = s.submit), (s.submit = () => (e.editorManager.triggerSave(), e.setDirty(!1), s._mceOldSubmit(s))))),
          (e.windowManager = ty(e)),
          (e.notificationManager = Jv(e)),
    ...
    getParam(e, t, n) {
      ...
      return o.isRegistered(e) || (C(n) ? o.register(e, { processor: n, default: t }) : o.register(e, { processor: P, default: t })), o.isSet(e) || v(t) ? o.get(e) : t;
    }
    hasPlugin(e, t) {
      return !(!j(El(this), e) || (t && void 0 === Zv.get(e)));
    }
    nodeChanged(e) {
    ...
    getContent(e) {
      return ((e, t = {}) => {
        ...
        return Gb(e, n).fold(R, (t) => {
          const n = ((e, t) => Ev(e).editor.getContent(t))(e, t);
          return Yb(e, n, t);
        });
      })(this, e);
    }
    insertContent(e, t) {
      t && (e = YN({ content: e }, t)), this.execCommand("mceInsertContent", !1, e);
    }
    resetContent(e) {
      void 0 === e ? Iv(this, this.startContent, { format: "raw" }) : Iv(this, e), this.undoManager.reset(), this.setDirty(!1), this.nodeChanged();
    }
    isDirty() {
      ...
      ((e) => {
        if (!e.removed) {
          ...
          o && e.save({ is_removing: !0 }),
            ...
            e.hasHiddenInput && r && Vv.remove(r.nextSibling),
            ((e) => {
              e.dispatch("remove");
            })(e),
    ...
    destroy(e) {
      ((e, t) => {
        ...
        e.destroyed ||
          (t || e.removed
            ? (t || (e.editorManager.off("beforeunload", e._beforeUnload), e.theme && e.theme.destroy && e.theme.destroy(), Hv(n), Hv(o)),
              ((e) => {
  ...
  const oR = (e) => {
    ...
    sR = (e) => {
      const t = nR;
      return (nR = K(nR, (t) => e !== t)), iR.activeEditor === e && (iR.activeEditor = nR.length > 0 ? nR[0] : null), iR.focusedEditor === e && (iR.focusedEditor = null), t.length !== nR.length;
    },
    ...
    iR = {
            ...
            0 === i.length
              ...
              : ZN(i, (s) => {
                  ((e, t) => e.inline && t.tagName.toLowerCase() in o)(e, s)
                    ? ay("Could not initialize inline editor on invalid inline target element", s)
                    : ((e, o, s) => {
      ...
      get(e) {
        return 0 === arguments.length ? nR.slice(0) : m(e) ? Q(nR, (t) => t.id === e).getOr(null) : w(e) && nR[e] ? nR[e] : null;
      },
      add(e) {
        const t = this,
          n = t.get(e.id);
        return (
          n === e ||
            ...
            eR ||
              ...
              window.addEventListener("beforeunload", eR))),
          e
        );
      },
      createEditor(e, t) {
        ...
        load: (n, o) => {
          ...
          if (void 0 !== e[n]) return e[n];
          {
            const a = new Promise((e, a) => {
              ...
              (t[n] = i.resolve),
                Us.ScriptLoader.loadScript(o).then(
                  () => i.start(s),
                  () => i.reject(r)
                );
            });
